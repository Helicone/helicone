...
const ChatCompletionRequestMessageContentPartText = z.object({ type: z.literal("text"), text: z.string() }).passthrough();
const ChatCompletionRequestDeveloperMessage = z
    ...
    .passthrough();
const ChatCompletionRequestSystemMessageContentPart = ChatCompletionRequestMessageContentPartText;
...
const ChatCompletionRequestUserMessage = z
    ...
    .passthrough();
const ChatCompletionRequestMessageContentPartRefusal = z.object({ type: z.literal("refusal"), refusal: z.string() }).passthrough();
...
const ChatCompletionRequestAssistantMessage = z
    ...
    .passthrough();
const ChatCompletionRequestToolMessageContentPart = ChatCompletionRequestMessageContentPartText;
...
const ChatCompletionFunctionCallOption = z.object({ name: z.string() }).passthrough();
        ...
        web_search_options: z
          .object({
            user_location: z
              ...
              .passthrough()
              .nullable(),
            search_context_size: WebSearchContextSize.optional().default("medium"),
          })
          .partial()
          .passthrough()
          .optional(),
