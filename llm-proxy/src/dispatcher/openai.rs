...
impl OpenaiDispatcher {
    const INFERENCE_PROVIDER: InferenceProvider = InferenceProvider::OpenAI;
...
impl Service<Request> for OpenaiDispatcher {
    ...
    fn call(&mut self, req: Request) -> Self::Future {
        ...
        tracing::trace!(provider = ?Self::INFERENCE_PROVIDER, "Dispatcher received request");
...
impl OpenaiDispatcher {
    ...
    async fn dispatch(&self, mut req: Request) -> Result<Response, Error> {
        let req_ctx = req
            ...
            .clone();
        let target_provider = Self::INFERENCE_PROVIDER;
        ...
        let base_url = provider_config.base_url.clone();
        {
            ...
            let openai_auth_header = format!("Bearer {}", provider_api_key.0);
            r.insert(
