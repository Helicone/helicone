...
INSERT INTO public.organization (id, name, owner, has_onboarded, organization_type, tier, has_onboarded)
VALUES
    ('83635a30-5ba6-41a8-8cc6-fb7df941b24a', 'Organization for Test', 'f76629c5-a070-4bbc-9918-64beaea48848', true, 'reseller', 'enterprise', true),
    ('a75d76e3-02e7-4d02-8a2b-c65ed27c69b2', 'Organization for Demo', 'd9064bb5-1501-4ec9-bfee-21ab74d645b8', true, 'reseller', 'enterprise', true);
