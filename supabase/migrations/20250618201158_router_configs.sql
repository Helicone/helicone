...
-- alter table "public"."router_keys" add constraint "public_router_keys_organization_id_fkey" FOREIGN KEY (organization_id) REFERENCES organization(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

-- alter table "public"."router_keys" validate constraint "public_router_keys_organization_id_fkey";
