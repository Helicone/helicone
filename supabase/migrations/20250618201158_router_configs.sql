...
alter table "public"."router_config_versions" add constraint "public_router_config_versions_router_ig_fkey" FOREIGN KEY (router_ig) REFERENCES routers(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."router_config_versions" validate constraint "public_router_config_versions_router_ig_fkey";
