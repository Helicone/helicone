...
-- Create an index on org_id and created_at desc if it doesn't exist
CREATE INDEX IF NOT EXISTS idx_cache_hits_org_id_created_at_desc ON public.cache_hits (org_id, created_at DESC);