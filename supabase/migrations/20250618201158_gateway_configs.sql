...
alter table "public"."router_configs" add constraint "public_router_configs_key_id_fkey" FOREIGN KEY (key_id) REFERENCES helicone_api_keys(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."router_configs" validate constraint "public_router_configs_key_id_fkey";
