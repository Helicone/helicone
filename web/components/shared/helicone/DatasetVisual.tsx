        ...
        <div className="w-full h-full py-2 bg-blue-500 rounded-2xl px-2">
          <div className="grid grid-cols-3 gap-2">
            <Button
              variant="ghost"
              size="lg"
              className="flex-1 basis-0 text-white bg-[#77A8F9] font-bold text-sm rounded-xl p-6 md:text-lg"
            >
            ...
            <Button
              variant="ghost"
              size="lg"
              className="flex-1 basis-0 text-white font-bold text-sm bg-[#77A8F9] rounded-xl p-6 md:text-lg"
            >
            ...
            <Button
              variant="secondary"
              size="lg"
              className="flex-1 basis-0 bg-white text-[#3c82f6] font-bold text-sm rounded-xl p-6 md:text-lg"
            >
