              ...
              <tr key={row.id}>
                ...
                >
                  {viewHandler && (
                    <button
                      type="button"
                      className="ml-3 inline-flex items-center rounded-md bg-muted p-1.5 text-xs text-muted-foreground shadow-sm hover:bg-accent hover:text-accent-foreground focus:outline-none disabled:cursor-not-allowed disabled:opacity-30 transition-colors"
                  ...
                  {editHandler && (
                    <button
                      type="button"
                      className="ml-3 inline-flex items-center rounded-md bg-muted p-1.5 text-xs text-muted-foreground shadow-sm hover:bg-accent hover:text-accent-foreground disabled:cursor-not-allowed disabled:opacity-30 transition-colors"
                  ...
                  {deleteHandler && (
                    <button
                      type="button"
                      className="ml-3 inline-flex items-center rounded-md bg-destructive/10 p-1.5 text-xs text-destructive shadow-sm hover:bg-destructive hover:text-destructive-foreground disabled:cursor-not-allowed disabled:opacity-30 transition-colors"
