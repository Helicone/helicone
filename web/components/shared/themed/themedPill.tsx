...
export const ThemedPill = ({
  ...
  return (
    <span className="inline-flex items-center rounded-2xl border border-sky-300 bg-sky-100 py-1.5 pl-4 pr-2 text-sm font-medium text-sky-700 dark:border-sky-700 dark:bg-sky-900 dark:text-sky-300">
      {label}
      <button
        onClick={onDelete}
        type="button"
