...
const DesktopSidebar = ({
  ...
  return (
    <>
      ...
      >
        <div className="w-full h-full flex flex-col justify-between border-r border-border">
          <div className="flex flex-col">
            {/* Top Left Corner */}
            <div
              className={`h-16 flex flex-row items-center border-b border-border
              ...
              <Button
                ...
                className={`${
                  isCollapsed
                    ...
                    : "h-full w-8 rounded-none"
                }   my-2 flex justify-center items-center bg-slate-50 dark:bg-slate-950 hover:bg-slate-100 dark:hover:bg-slate-900`}
              >
                {isCollapsed ? (
            ...
            {canShowInfoBox &&
              ...
              (isCollapsed ? (
                <ProFeatureWrapper featureName="pro" enabled={false}>
                  <Button variant="action" size="none" className="w-9 h-9">
                    <Rocket className="h-4 w-4" />
                  </Button>
                </ProFeatureWrapper>
              ) : (
                <div className="w-full bg-slate-50 dark:bg-slate-900 rounded border border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 flex flex-col md:flex-row md:gap-2 gap-4 justify-between md:justify-center md:items-center items-start px-3 py-2 mx-2 font-medium">
