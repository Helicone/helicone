  ...
  return (
    <div className="flex flex-col space-y-4 p-6">
      ...
      <div className="bg-muted/50 rounded-lg p-4 text-sm text-muted-foreground">
        ...
        <p>
          The limits set here create a rolling window rate limit for the entire
          organization. All API usage from Access Keys belonging to members of
          this organization will count towards this collective limit. Once the
          spending limit is reached within the specified number of days, all API
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-xs text-muted-foreground">
                    ...
                    org.governance_settings?.days === null
                      ? "Unlimited"
                      : `Limit: $${org.governance_settings?.limitUSD || 0} / ${
                          org.governance_settings?.days || 0
                        } days`}
                  </span>
                </div>
                    ...
                    <>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          setEditingLimit(
                            org.governance_settings?.limitUSD?.toString() || "0"
                          );
                          setEditingDays(
                            org.governance_settings?.days?.toString() || "10"
                          );
                        }}
                        disabled={updateGovernanceOrg.isLoading}
                      >
