  ...
  return (
    <div className="bg-white">
      <div className="relative isolate h-screen">
        <svg
          className="absolute inset-0 -z-10 h-full w-full stroke-gray-200 [mask-image:radial-gradient(100%_90%_at_top_center,white,transparent)]"
          aria-hidden="true"
        >
          <defs>
            <pattern
        ...
        <div className="left-4 sm:left-16 absolute">
          <svg
            width="160"
            height="86"
            viewBox="0 0 447 86"
        ...
        <div className="h-full flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
          <div className="mx-auto max-w-xl w-full bg-white p-8 sm:p-16 rounded-xl shadow-xl border border-gray-200">
            <div>
