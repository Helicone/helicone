    ...
    <>
      <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 w-full">
        <div className="relative hidden flex-1 lg:flex flex-col bg-gradient-to-tr from-black to-gray-700 col-span-1">
          ...
          <div className="bottom-0 absolute text-gray-100 p-12">
            <p className="text-xl leading-relaxed">
              {`“As an early-stage startup, speed is everything at Trelent. Helicone helps us quickly understand user behaviour when we're iterating with OpenAI, shortening our testing cycles.”`}
            </p>
