  ...
  return (
    <div className="relative">
      <div className="fixed inset-0 pointer-events-none">
        <div className="relative h-screen max-w-7xl mx-auto">
          <LogoBox
            ...
            className="w-[130px] h-[130px] 2xl:w-[190px] 2xl:h-[190px] absolute bottom-0 left-20 rotate-[13deg] pointer-events-auto"
      ...
      <div className="relative h-screen">
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-200px)] p-4">
