  ...
  protected buildSpecific(): SpecificFields {
    const getResponseText = () => {
      ...
      if (statusCode === 200) {
        ...
        if (this.response.response_body?.body) {
          return this.response.response_body?.body.completion;
        }
    ...
    return {
      ...
      model:
        this.response.request_body.model ||
        this.response.response_body.body?.model,
      render:
        ...
        this.response.response_status === null ? (
          ...
          <Completion
            ...
            response={{
              title: "Response",
              text: this.response.response_body?.body
