    ...
    <div className="flex flex-col space-y-16">
      {!isAlertsEnabled() ? (
        <div className="flex justify-center items-center min-h-[calc(100vh-200px)]">
          <FeatureUpgradeCard
            title="Unlock Alerts"
            description="The Free plan does not include the Alerts feature, but getting access is easy."
            infoBoxText="Get notified when your LLM usage meets specific conditions."
            documentationLink="https://docs.helicone.ai/features/monitoring/alerts"
          />
        </div>
      ) : (
        <>
