...
const OnboardingIntegrateShell = () => {
  const org = useOrg();
    ...
    <OnboardingHeader>
      <div className="flex flex-col gap-6 mx-auto max-w-4xl py-12">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          {/* Async Card */}
          <NavLink to="/onboarding/integrate/async" className="flex-1">
          ...
          {/* Proxy Card */}
          <NavLink to="/onboarding/integrate/proxy" className="flex-1">
            <Card className="h-full transition-colors hover:bg-[hsl(var(--muted))]">
              <div className="p-4">
                <div className="flex items-start gap-3">
                  <div className="flex h-10 w-10 md:h-12 md:w-12 items-center justify-center bg-[hsl(var(--muted))] rounded-md border border-[hsl(var(--border))]">
        ...
        <div className="flex flex-col gap-4">
          <NavLink
            to="https://docs.helicone.ai/references/proxy-vs-async"
            target="_blank"
          >
            <Button
              variant="link"
...
export default OnboardingIntegrateShell;
