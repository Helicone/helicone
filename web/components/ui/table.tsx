...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto overflow-x-scroll">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-[hsl(var(--border))] hover:bg-[hsl(var(--muted))] data-[state=selected]:bg-[hsl(var(--muted))]",
      className,
    )}
    {...props}
  />
