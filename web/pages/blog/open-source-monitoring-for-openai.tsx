...
interface MonitoringForOpenAIBlogProps {}

const MonitoringForOpenAIBlog = (props: MonitoringForOpenAIBlogProps) => {
  const {} = props;

  return (
    <MetaData title="Open-Source Monitoring for OpenAI with Helicone">
      <NavBarV2 />
      <section>
        <div className="bg-white px-6 py-32 lg:px-8 antialiased">
          <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
            <p className="text-base font-semibold leading-7 text-indigo-600">
              Open-Source
            </p>
            <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Monitoring and Observability for OpenAI with Helicone
            </h1>
            <figcaption className="mt-6 flex gap-x-4">
              <img
                className="h-6 w-6 flex-none rounded-full bg-gray-50"
                src="/assets/blog/sn-headshot.png"
                alt=""
              />
...
export default MonitoringForOpenAIBlog;
