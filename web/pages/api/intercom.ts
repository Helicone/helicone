      ...
      case "notification_event":
        ...
        if (
          ...
          if (
            ...
            console.log(
              "Using source for first message:",
              JSON.stringify(conversation.source, null, 2),
            );
          } else {
            ...
            console.log(
              "Latest message part:",
              JSON.stringify(latestPart, null, 2),
            );
          ...
          if (
            ...
            console.log(
              "Skipping message from organization admin to avoid loops",
            );
            return res
              .status(200)
          ...
          if (threadTs && !threadTs.includes(".")) {
            console.log(
              "Clearing invalid mapping with bad thread_ts:",
              threadTs,
            );
          ...
          const slackResponse = await service.sendSlackMessage(
            ...
            conversation.source?.url ||
              `https://app.intercom.com/a/apps/${process.env.INTERCOM_APP_ID || "mna0ba2h"}/inbox/inbox/all/conversations/${conversation.id}`,
            attachments,
          );
