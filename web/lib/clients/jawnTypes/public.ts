...
Json: JsonObject;
    ...
    Model: {
      timeSeriesData: {
        negativeFeedbackCount: components["schemas"]["TimeSeriesMetric"][];
        positiveFeedbackCount: components["schemas"]["TimeSeriesMetric"][];
        negativePercentage: components["schemas"]["TimeSeriesMetric"][];
        positivePercentage: components["schemas"]["TimeSeriesMetric"][];
