 ...
 * });
 */
export function useFetchRunsQuery(
  baseOptions?: Apollo.QueryHookOptions<FetchRunsQuery, FetchRunsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FetchRunsQuery, FetchRunsQueryVariables>(
    FetchRunsDocument,
    options
  );
}
export function useFetchRunsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    FetchRunsQuery,
    FetchRunsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<FetchRunsQuery, FetchRunsQueryVariables>(
    FetchRunsDocument,
    options
  );
}
export type FetchRunsQueryHookResult = ReturnType<typeof useFetchRunsQuery>;
export type FetchRunsLazyQueryHookResult = ReturnType<
  typeof useFetchRunsLazyQuery
>;
export type FetchRunsQueryResult = Apollo.QueryResult<
  FetchRunsQuery,
  FetchRunsQueryVariables
>;
