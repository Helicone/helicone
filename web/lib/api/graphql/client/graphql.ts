...
export type FetchTasksQuery = {
  ...
  heliconeNode?: Array<{
    ...
    updated_at: string;
    job_id: string;
    parent_node_ids?: Array<string> | null;
    properties?: Array<{
      __typename?: "Property";
      name?: string | null;
      value?: string | null;
...
export const FetchRunsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FetchRuns" },
      variableDefinitions: [
        {
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                kind: "NamedType",
                name: { kind: "Name", value: "HeliconeJobFilter" },
              },
            },
          },
        },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "heliconeJob" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "filters" },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "timeout_seconds" },
                },
                { kind: "Field", name: { kind: "Name", value: "node_count" } },
                {
                  kind: "Field",
...
} as unknown as DocumentNode<FetchRunsQuery, FetchRunsQueryVariables>;
export const FetchTasksDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FetchTasks" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "heliconeNodeId" },
          },
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                kind: "NamedType",
                name: { kind: "Name", value: "HeliconeNodeFilter" },
              },
            },
          },
        },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "heliconeNode" },
            arguments: [
              {
                kind: "Argument",
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "parent_node_ids" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "properties" },
...
} as unknown as DocumentNode<FetchTasksQuery, FetchTasksQueryVariables>;
