...
export type TextOperators = Record<
  "equals" | "not-equals" | "like" | "ilike" | "contains" | "not-contains" | "is-null" | "is-not-null" | "is-empty" | "is-not-empty",
  string | null
>;

export type NumberOperators = Record<
  "equals" | "not-equals" | "gte" | "lte" | "lt" | "gt" | "is-null" | "is-not-null",
  number | null
>;

export type BooleanOperators = Record<"equals" | "is-null" | "is-not-null", boolean>;
