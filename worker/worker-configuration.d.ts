/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars false` (hash: dc0d78cbb435a5aa09e8c123aeebf445)
// Runtime types generated with workerd@1.20250617.0 2025-08-03 nodejs_compat_v2
declare namespace Cloudflare {
	interface Env {
		...
		PROVIDER_KEY_CACHE: DurableObjectNamespace<import("./src/index").ProviderKeyCache>;
...
type AIGatewayProviders = 'workers-ai' | 'anthropic' | 'aws-bedrock' | 'azure-openai' | 'google-vertex-ai' | 'huggingface' | 'openai' | 'perplexity-ai' | 'replicate' | 'groq' | 'google-ai-studio' | 'mistral' | 'grok' | 'openrouter' | 'deepseek' | 'cerebras' | 'cartesia' | 'elevenlabs' | 'adobe-firefly';
