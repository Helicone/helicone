/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars false` (hash: 07ad125f9abce077753efbf7b7e2282e)
...
declare namespace Cloudflare {
  interface Env {
    ...
    RATE_LIMITER: DurableObjectNamespace<
      import("./src/index").InMemoryRateLimiter
    >;
    RATE_LIMITER_SQL: DurableObjectNamespace<
      import("./src/index").RateLimiterDO
    >;
    WALLET: DurableObjectNamespace<import("./src/index").Wallet>;
    REQUEST_BODY_BUFFER: DurableObjectNamespace<
      import("./src/index").RequestBodyBufferContainer
    >;
