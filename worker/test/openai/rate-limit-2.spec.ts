...
describe("Durable Object Rate Limiter Tests", () => {
  ...
  describe("Rate Limiting with Durable Objects", () => {
    ...
    // SKIP: Durable Object tests are unstable in vitest due to DO invalidation
    // Run manually with: npx wrangler dev and test via HTTP requests
    // See test/durable-objects/README.md for manual testing instructions
    it.skip("should deduct cost from remaining quota for cents-based rate limiting", async () => {
    ...
    // Run manually with: npx wrangler dev and test via HTTP requests
    // See test/durable-objects/README.md for manual testing instructions
    it.skip("should enforce rate limit after quota is exceeded", async () => {
      mockHeliconeResponse();
