...
describe("Moonshot AI Registry Tests", () => {
  ...
  describe("BYOK Tests - kimi-k2-thinking with DeepInfra", () => {
    describe("kimi-k2-thinking/deepinfra", () => {
      it("should handle deepinfra provider", () =>
        runGatewayTest({
          model: "kimi-k2-thinking/deepinfra",
          expected: {
            providers: [
              {
                url: "https://api.deepinfra.com/v1/openai/chat/completions",
                ...
                data: createOpenAIMockResponse("moonshotai/Kimi-K2-Thinking"),
                expects: deepinfraAuthExpectations,
              },
            ],
            finalStatus: 200,
  ...
  describe("Error scenarios - kimi-k2-thinking with DeepInfra Provider", () => {
    it("should handle DeepInfra provider failure", () =>
      runGatewayTest({
        model: "kimi-k2-thinking/deepinfra",
        expected: {
  ...
  describe("Provider validation - kimi-k2-thinking with DeepInfra", () => {
    it("should construct correct DeepInfra URL for kimi-k2-thinking", () =>
      runGatewayTest({
        model: "kimi-k2-thinking/deepinfra",
        expected: {
          providers: [
  ...
  describe("BYOK Tests - kimi-k2-thinking with Fireworks", () => {
    describe("kimi-k2-thinking/fireworks", () => {
      it("should handle fireworks provider", () =>
        runGatewayTest({
          model: "kimi-k2-thinking/fireworks",
          expected: {
            providers: [
              {
                url: "https://api.fireworks.ai/inference/v1/chat/completions",
                ...
                data: createOpenAIMockResponse("fireworks/kimi-k2-thinking"),
                expects: fireworksAuthExpectations,
              },
            ],
            finalStatus: 200,
  ...
  describe("Error scenarios - kimi-k2-thinking with Fireworks Provider", () => {
    it("should handle Fireworks provider failure", () =>
      runGatewayTest({
        model: "kimi-k2-thinking/fireworks",
        expected: {
  ...
  describe("Provider validation - kimi-k2-thinking with Fireworks", () => {
    it("should construct correct Fireworks URL for kimi-k2-thinking", () =>
      runGatewayTest({
        model: "kimi-k2-thinking/fireworks",
        expected: {
          providers: [
          ...
          providers: [
            {
              url: "https://api.fireworks.ai/inference/v1/chat/completions",
              response: "success",
              model: "fireworks/kimi-k2-thinking", // Should map to the correct provider model ID
              data: createOpenAIMockResponse("fireworks/kimi-k2-thinking"),
              expects: fireworksAuthExpectations,
            },
          ],
