...
describe("xAI Registry Tests", () => {
  ...
  describe("BYOK Tests - xAI Grok Models", () => {
    ...
    describe("grok-4.1-fast-non-reasoning", () => {
      it("should handle xai provider", () =>
        runGatewayTest({
  ...
  describe("Error scenarios - grok-4-fast-non-reasoning", () => {
    it("should handle xAI provider failure for grok-4-fast-non-reasoning", () =>
      runGatewayTest({
        model: "grok-4-fast-non-reasoning/xai",
        expected: {
          providers: [
    ...
    it("should handle rate limiting from xAI for grok-4-fast-non-reasoning", () =>
      runGatewayTest({
        model: "grok-4-fast-non-reasoning/xai",
        expected: {
          providers: [
    ...
    it("should handle authentication failure for grok-4-fast-non-reasoning", () =>
      runGatewayTest({
        model: "grok-4-fast-non-reasoning/xai",
        expected: {
          providers: [
    ...
    it("should handle model not found error for grok-4-fast-non-reasoning", () =>
      runGatewayTest({
        model: "grok-4-fast-non-reasoning/xai",
        expected: {
          providers: [
    ...
    it("should handle timeout for grok-4-fast-non-reasoning", () =>
      runGatewayTest({
        model: "grok-4-fast-non-reasoning/xai",
        expected: {
          providers: [
    ...
    it("should handle bad request error for grok-4-fast-non-reasoning", () =>
      runGatewayTest({
        model: "grok-4-fast-non-reasoning/xai",
        expected: {
          providers: [
  ...
  describe("Error scenarios - grok-4.1-fast-non-reasoning", () => {
    it("should handle xAI provider failure for grok-4.1-fast-non-reasoning", () =>
      runGatewayTest({
        model: "grok-4.1-fast-non-reasoning/xai",
        expected: {
          providers: [
    ...
    it("should handle rate limiting from xAI for grok-4.1-fast-non-reasoning", () =>
      runGatewayTest({
        model: "grok-4.1-fast-non-reasoning/xai",
        expected: {
          providers: [
    ...
    it("should handle authentication failure for grok-4.1-fast-non-reasoning", () =>
      runGatewayTest({
        model: "grok-4.1-fast-non-reasoning/xai",
        expected: {
          providers: [
    ...
    it("should handle model not found error for grok-4.1-fast-non-reasoning", () =>
      runGatewayTest({
        model: "grok-4.1-fast-non-reasoning/xai",
        expected: {
          providers: [
    ...
    it("should handle timeout for grok-4.1-fast-non-reasoning", () =>
      runGatewayTest({
        model: "grok-4.1-fast-non-reasoning/xai",
        expected: {
          providers: [
    ...
    it("should handle bad request error for grok-4.1-fast-non-reasoning", () =>
      runGatewayTest({
        model: "grok-4.1-fast-non-reasoning/xai",
        expected: {
          providers: [
