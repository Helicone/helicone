    ...
    try {
      ...
      if (chunk.type === "text") {
        ...
        if (chunk.usage) {
          ...
          usage = {
            prompt_tokens:
              chunk.usage.inputTokens || chunk.usage.prompt_tokens || 0,
            completion_tokens:
              chunk.usage.outputTokens || chunk.usage.completion_tokens || 0,
            total_tokens:
              chunk.usage.totalTokens || chunk.usage.total_tokens || 0,
          };
        }
      }
    } catch (e) {
