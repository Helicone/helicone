/**
 * Provider and Endpoint Definitions
 * Centralizes provider configurations and endpoint patterns
 */

export interface ProviderEndpoint {
  /** The URL pattern for this endpoint type */
  path: string;
  /** HTTP method if not POST */
...
export interface ProviderConfig {
  ...
  /** Whether this provider requires a project ID */
  requiresProjectId?: boolean;
  /** Whether this provider requires a region */
  requiresRegion?: boolean;
  /** Whether this provider requires a deployment name (Azure) */
  requiresDeploymentName?: boolean;
  /** Available regions for this provider */
  regions?: string[];
  /** API version if applicable */
  apiVersion?: string;
  /** Different endpoint patterns this provider supports */
  endpoints: Record<string, ProviderEndpoint | string>;
}

/**
 * Provider configurations
 * Maps provider identifiers to their configuration
 */
export const providers: Record<string, ProviderConfig> = {
  ...
  vertex: {
    ...
    endpoints: {
      anthropic: {
        ...
        description: 'Anthropic models hosted on Vertex AI',
      },
      google: {
        path: '/v1/projects/{projectId}/locations/{region}/publishers/google/models/{model}:generateContent',
        description: 'Google native models (Gemini, etc.)',
      },
      custom: {
        path: '/v1/projects/{projectId}/locations/{region}/endpoints/{endpointId}:predict',
        description: 'Custom deployed models',
      },
    },
  },
  ...
  bedrock: {
    ...
    endpoints: {
      ...
      invokeStream: '/model/{modelId}/invoke-with-response-stream',
      converse: '/model/{modelId}/converse',
      converseStream: '/model/{modelId}/converse-stream',
    },
  },
  ...
  'azure-openai': {
    ...
    endpoints: {
      ...
      completions: '/openai/deployments/{deploymentName}/completions?api-version={apiVersion}',
      embeddings: '/openai/deployments/{deploymentName}/embeddings?api-version={apiVersion}',
    },
  },
...
/**
 * Helper function to get a provider configuration
 */
...
/**
 * Helper function to build a full URL for a provider endpoint
 */
...
/**
 * Type guard to check if endpoint has detailed configuration
 */
