...
// Model imports
import agentica_orgModels from "./authors/agentica-org/models.json";
import ai21Models from "./authors/ai21/models.json";
import aion_labsModels from "./authors/aion-labs/models.json";
import alfredprosModels from "./authors/alfredpros/models.json";
import alpindaleModels from "./authors/alpindale/models.json";
import amazonModels from "./authors/amazon/models.json";
import anthracite_orgModels from "./authors/anthracite-org/models.json";
import anthropicModels from "./authors/anthropic/models.json";
import arcee_aiModels from "./authors/arcee-ai/models.json";
import arliaiModels from "./authors/arliai/models.json";
import baiduModels from "./authors/baidu/models.json";
import bytedanceModels from "./authors/bytedance/models.json";
import cognitivecomputationsModels from "./authors/cognitivecomputations/models.json";
import cohereModels from "./authors/cohere/models.json";
import deepseekModels from "./authors/deepseek/models.json";
import eleutheraiModels from "./authors/eleutherai/models.json";
import featherlessModels from "./authors/featherless/models.json";
import googleModels from "./authors/google/models.json";
import grypheModels from "./authors/gryphe/models.json";
import inceptionModels from "./authors/inception/models.json";
import infermaticModels from "./authors/infermatic/models.json";
import inflectionModels from "./authors/inflection/models.json";
import liquidModels from "./authors/liquid/models.json";
import mancerModels from "./authors/mancer/models.json";
...
import morphModels from "./authors/morph/models.json";
import neversleepModels from "./authors/neversleep/models.json";
import nousresearchModels from "./authors/nousresearch/models.json";
...
import raifleModels from "./authors/raifle/models.json";
import rekaaiModels from "./authors/rekaai/models.json";
import sao10kModels from "./authors/sao10k/models.json";
import sarvamaiModels from "./authors/sarvamai/models.json";
import scb10xModels from "./authors/scb10x/models.json";
import shisa_aiModels from "./authors/shisa-ai/models.json";
import sophosympatheiaModels from "./authors/sophosympatheia/models.json";
import switchpointModels from "./authors/switchpoint/models.json";
import tencentModels from "./authors/tencent/models.json";
import thedrummerModels from "./authors/thedrummer/models.json";
import thudmModels from "./authors/thudm/models.json";
import tngtechModels from "./authors/tngtech/models.json";
import undi95Models from "./authors/undi95/models.json";
import x_aiModels from "./authors/x-ai/models.json";
import z_aiModels from "./authors/z-ai/models.json";

// Endpoint imports
import agentica_orgEndpoints from "./authors/agentica-org/endpoints.json";
import ai21Endpoints from "./authors/ai21/endpoints.json";
import aion_labsEndpoints from "./authors/aion-labs/endpoints.json";
import alfredprosEndpoints from "./authors/alfredpros/endpoints.json";
import alpindaleEndpoints from "./authors/alpindale/endpoints.json";
import amazonEndpoints from "./authors/amazon/endpoints.json";
import anthracite_orgEndpoints from "./authors/anthracite-org/endpoints.json";
import anthropicEndpoints from "./authors/anthropic/endpoints.json";
import arcee_aiEndpoints from "./authors/arcee-ai/endpoints.json";
import arliaiEndpoints from "./authors/arliai/endpoints.json";
import baiduEndpoints from "./authors/baidu/endpoints.json";
import bytedanceEndpoints from "./authors/bytedance/endpoints.json";
import cognitivecomputationsEndpoints from "./authors/cognitivecomputations/endpoints.json";
import cohereEndpoints from "./authors/cohere/endpoints.json";
import deepseekEndpoints from "./authors/deepseek/endpoints.json";
import eleutheraiEndpoints from "./authors/eleutherai/endpoints.json";
import featherlessEndpoints from "./authors/featherless/endpoints.json";
import googleEndpoints from "./authors/google/endpoints.json";
import grypheEndpoints from "./authors/gryphe/endpoints.json";
import inceptionEndpoints from "./authors/inception/endpoints.json";
import infermaticEndpoints from "./authors/infermatic/endpoints.json";
import inflectionEndpoints from "./authors/inflection/endpoints.json";
import liquidEndpoints from "./authors/liquid/endpoints.json";
import mancerEndpoints from "./authors/mancer/endpoints.json";
...
import morphEndpoints from "./authors/morph/endpoints.json";
import neversleepEndpoints from "./authors/neversleep/endpoints.json";
import nousresearchEndpoints from "./authors/nousresearch/endpoints.json";
...
import raifleEndpoints from "./authors/raifle/endpoints.json";
import rekaaiEndpoints from "./authors/rekaai/endpoints.json";
import sao10kEndpoints from "./authors/sao10k/endpoints.json";
import sarvamaiEndpoints from "./authors/sarvamai/endpoints.json";
import scb10xEndpoints from "./authors/scb10x/endpoints.json";
import shisa_aiEndpoints from "./authors/shisa-ai/endpoints.json";
import sophosympatheiaEndpoints from "./authors/sophosympatheia/endpoints.json";
import switchpointEndpoints from "./authors/switchpoint/endpoints.json";
import tencentEndpoints from "./authors/tencent/endpoints.json";
import thedrummerEndpoints from "./authors/thedrummer/endpoints.json";
import thudmEndpoints from "./authors/thudm/endpoints.json";
import tngtechEndpoints from "./authors/tngtech/endpoints.json";
import undi95Endpoints from "./authors/undi95/endpoints.json";
import x_aiEndpoints from "./authors/x-ai/endpoints.json";
import z_aiEndpoints from "./authors/z-ai/endpoints.json";
...
export const models: Record<string, Model> = {
  ...
  ...alpindaleModels,
  ...amazonModels,
  ...anthracite_orgModels,
  ...anthropicModels,
  ...arcee_aiModels,
  ...arliaiModels,
  ...baiduModels,
  ...bytedanceModels,
  ...cognitivecomputationsModels,
  ...cohereModels,
  ...deepseekModels,
  ...eleutheraiModels,
  ...featherlessModels,
...
export const endpoints: Record<string, Endpoint[]> = {
  ...agentica_orgEndpoints,
  ...ai21Endpoints,
  ...aion_labsEndpoints,
  ...alfredprosEndpoints,
  ...alpindaleEndpoints,
  ...amazonEndpoints,
  ...anthracite_orgEndpoints,
  ...anthropicEndpoints,
  ...arcee_aiEndpoints,
  ...arliaiEndpoints,
  ...baiduEndpoints,
  ...bytedanceEndpoints,
  ...cognitivecomputationsEndpoints,
  ...cohereEndpoints,
  ...deepseekEndpoints,
  ...eleutheraiEndpoints,
  ...featherlessEndpoints,
  ...googleEndpoints,
  ...grypheEndpoints,
  ...inceptionEndpoints,
  ...infermaticEndpoints,
  ...
  ...scb10xEndpoints,
  ...shisa_aiEndpoints,
  ...sophosympatheiaEndpoints,
  ...switchpointEndpoints,
  ...tencentEndpoints,
  ...thedrummerEndpoints,
  ...thudmEndpoints,
  ...tngtechEndpoints,
...
export const authors: Record<string, Author> = {
  [agentica_orgMetadata.slug]: {
    ...
    models: Object.keys(agentica_orgModels),
  },
  [ai21Metadata.slug]: {
  ...
  [anthracite_orgMetadata.slug]: {
    ...
    models: Object.keys(anthracite_orgModels),
  },
  ...
  [arcee_aiMetadata.slug]: {
    ...
    models: Object.keys(arcee_aiModels),
  },
  [arliaiMetadata.slug]: {
    slug: arliaiMetadata.slug,
    name: arliaiMetadata.name,
    models: Object.keys(arliaiModels),
  },
  [baiduMetadata.slug]: {
    slug: baiduMetadata.slug,
    name: baiduMetadata.name,
    models: Object.keys(baiduModels),
  },
  ...
  [cognitivecomputationsMetadata.slug]: {
    ...
    models: Object.keys(cognitivecomputationsModels),
  },
  [cohereMetadata.slug]: {
  ...
  [eleutheraiMetadata.slug]: {
    ...
    models: Object.keys(eleutheraiModels),
  },
  ...
  [grypheMetadata.slug]: {
    ...
    models: Object.keys(grypheModels),
  },
  ...
  [infermaticMetadata.slug]: {
    ...
    models: Object.keys(infermaticModels),
  },
  ...
  [liquidMetadata.slug]: {
    ...
    models: Object.keys(liquidModels),
  },
  [mancerMetadata.slug]: {
    slug: mancerMetadata.slug,
    name: mancerMetadata.name,
    models: Object.keys(mancerModels),
  },
  ...
  [pygmalionaiMetadata.slug]: {
    ...
    models: Object.keys(pygmalionaiModels),
  },
  [qwenMetadata.slug]: {
  ...
  [raifleMetadata.slug]: {
    ...
    models: Object.keys(raifleModels),
  },
  [rekaaiMetadata.slug]: {
