...
WHEN (request_response_rmt.provider = 'OPENROUTER') THEN (
  CASE
  WHEN (request_response_rmt.model ILIKE 'google/gemini-2.0-flash-thinking-exp:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'sophosympatheia/rogue-rose-103b-v0.2:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'google/gemini-2.0-flash-thinking-exp-1219:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'google/gemini-2.0-flash-exp:free') THEN 
WHEN (request_response_rmt.model ILIKE 'google/gemini-exp-1206:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'google/gemini-exp-1121:free') THEN 
WHEN (request_response_rmt.model ILIKE 'google/learnlm-1.5-pro-experimental:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'google/gemini-exp-1114:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.2-3b-instruct:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.2-1b-instruct:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.2-90b-vision-instruct:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.2-11b-vision-instruct:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'google/gemini-flash-1.5-exp') THEN 
...
WHEN (request_response_rmt.model ILIKE 'google/gemini-flash-1.5-8b-exp') THEN 
...
WHEN (request_response_rmt.model ILIKE 'google/gemini-pro-1.5-exp') THEN 
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.1-405b-instruct:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.1-8b-instruct:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.1-70b-instruct:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'qwen/qwen-2-7b-instruct:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'google/gemma-2-9b-it:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'mistralai/mistral-7b-instruct:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'microsoft/phi-3-mini-128k-instruct:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'microsoft/phi-3-medium-128k-instruct:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3-8b-instruct:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'openchat/openchat-7b:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'undi95/toppy-m-7b:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'openrouter/auto') THEN 
...
WHEN (request_response_rmt.model ILIKE 'huggingfaceh4/zephyr-7b-beta:free') THEN 
...
WHEN (request_response_rmt.model ILIKE 'gryphe/mythomax-l2-13b:free') THEN 
