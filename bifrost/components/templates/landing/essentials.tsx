                        ...
                        <div className="md:flex-shrink-0">
                            <div className="flex items-center justify-between gap-2 p-4">
                                <div className="bg-white rounded-lg py-2 pl-4 ">
                                    ...
                                    <p className="text-[9px] font-medium text-black inline-block pl-2 pr-4">
                            ...
                            <div className="p-4 bg-white ">
                                ...
                                <p className="text-gray-500 text-sm">Filter, segment and analyze your requests.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="md:flex flex-col">
                        ...
                        <div className="relative">
                            <div className="relative pt-3 pb-5">
                                <Image
                                    className="translate-x-16 scale-125 mt-5  "
