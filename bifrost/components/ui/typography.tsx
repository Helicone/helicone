...
export const typography = {
  // Headings
  h1: "scroll-m-20 font-sans text-3xl leading-10 font-semibold tracking-tight lg:text-4xl text-foreground",
  "h1-large":
    "scroll-m-20 font-sans text-5xl leading-10 font-extrabold tracking-tight text-foreground",
  h2: "scroll-m-20 font-sans text-3xl leading-9 font-semibold tracking-tight text-foreground",
  h3: "scroll-m-20 font-sans text-2xl leading-8 font-semibold tracking-tight text-foreground",
  h4: "scroll-m-20 font-sans text-xl leading-7 font-semibold tracking-tight text-foreground",

  // Body text
  p: "font-sans text-base leading-7 font-normal text-foreground",
  lead: "font-sans text-xl leading-7 font-normal text-muted-foreground",
  large: "font-sans text-lg leading-7 font-semibold text-foreground",
  small: "font-sans text-sm leading-4 font-medium text-foreground",
  muted: "font-sans text-sm font-normal text-muted-foreground",

  // Special elements
  blockquote:
    "font-sans text-base leading-6 font-normal mt-6 border-l-2 border-border pl-6 italic text-muted-foreground",
  code: "font-mono text-sm leading-5 font-semibold relative rounded bg-muted px-[0.3rem] py-[0.2rem] text-foreground",

  // Lists
  list: "font-sans text-base leading-7 font-normal my-6 ml-6 list-disc [&>li]:mt-2 text-foreground",

  // Table
  "table-head": "font-sans text-base font-bold text-foreground",
  "table-cell": "font-sans text-base font-normal text-foreground",
} as const;
