  ...
  return (
    <div className="py-10 sm:p-8 grid grid-cols-1 lg:grid-cols-12 bg-white rounded-md">
      ...
      <div className="py-[24px] col-span-7">
        <div className="grid grid-cols-1 sm:grid-cols-2 divide-y divide-slate-200 rounded-lg divide-x border-slate-200">
          <div className="rounded-t-lg sm:rounded-tr-none p-[24px] flex flex-col border-t border-l border-r sm:border-r-0 border-border">
          ...
          <div className="p-4 flex flex-col !border-r sm:rounded-tr-lg border-border">
            <h3 className="text-sm font-medium bg-[#F1F5F9] w-fit px-[16px] py-[8px] rounded-[3px] text-slate-900">
              Non-profits
            </h3>
            <p className="text-3xl font-bold mt-[32px] text-slate-900">
