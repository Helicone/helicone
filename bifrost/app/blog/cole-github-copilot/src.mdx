...
![Our co-founder's Take on GitHub Copilot](/static/blog/cole-copilot.png)
...
Try writing a log. As you type, see how Copilot makes recommendations and adapt to it. You should learn how to prompt it to work for you! 
