...
Arize AI created a very in-depth read about why LLM observability is crucial to make your application reliable, and key issues with LLM that make building with LLM incredibly difficult. 
