...
![A Helicone Guide for Datadog Users Building with LLM's](/static/blog/datadog/title.webp)
...
![2-lines of code to integrate with Helicone](/static/blog/datadog/code.png)
