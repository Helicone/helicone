...
![Custom Properties: Understanding Your Users Better and Delivering a Top-Tier Experience](/static/blog/custom-properties/cover.png)
...
## Use Case 2: Session Tracking 
    
Understanding how your users interacts with your LLM from the beginning to end. 
    
### Implementation

    ```python
        headers={
            "Helicone-Property-Session": "24", # simply add this header to your request
            "Helicone-Property-SessionStart": "2024-06-07T12:00:00Z", 
            "Helicone-Property-SessionEnd": "2024-06-07T12:30:00Z", 
        }
    ```

### Best for:  

    - Tracking session lengths and frequency
    - Detect session-related issues
    - Refine the user experience by understanding session patterns


## Use Case 3: User and Feature Segmentation 
...
<a href="https://tryjournalist.com/" target="_blank" rel="noopener noreferrer">Journalist AI</a> is a platform that automates content creation for writers seeking efficient and high-quality content production, by generating written articles, blog posts, and other materials based on user input. 

![Journalist AI](/static/blog/custom-properties/journalist-ai.png)
...
<a href="https://www.greptile.com/" target="_blank" rel="noopener noreferrer">Greptile</a> is a platform that helps users search and analyze text data from sources including websites, documents, and databases, using advanced natural language processing (NLP) techniques. 

![Greptile](/static/blog/custom-properties/greptile.png)
