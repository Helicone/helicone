...
## 1. <a href="https://www.helicone.ai/" target="_blank">Helicone</a>
...
Helicone is an open-source LLM observability and monitoring platform purpose-built for
developers to monitor, debug, and optimize their LLM applications. With the flexibility
to be self-hosted or used as a gateway with a simple **<span style={{color: '#0ea5e9'}}>1-line integration</span>**, it provides instant insights into latency, costs, time to first tokens
(TTFT) and more.

### Top features

1. **<a href="https://docs.helicone.ai/features/sessions" target="_blank">Sessions</a>** - Group, track and visualize multi-step agent workflows and LLM interactions.
2. **<a href="https://docs.helicone.ai/features/experiments" target="_blank">Experiments</a>** - Prevent prompt regression by testing prompts variations with production data and evaluating outputs.
3. **<a href="https://docs.helicone.ai/features/prompts" target="_blank">Prompts</a>** - Version and test prompts, then compare outputs before pushing to production.
4. **<a href="https://docs.helicone.ai/features/advanced-usage/custom-properties" target="_blank">Custom properties</a>** - Segment data to understand your users better.
...
Helicone is fully <a href="https://github.com/Helicone/helicone" target="_blank">open-source</a> and free to start. Companies can also self-host Helicone within their infrastructure. This ensures that you have full control over the application, flexibility and customization tailored to specific business needs. Compare to LangSmith, the self-host option is only available for users on enterprise plan.
...
Helicone can also handle <a href="https://upstash.com/blog/implementing-upstash-kafka-with-cloudflare-workers" target="_blank">billions of requests</a>, making it a dependable option for businesses with high traffic. Acting as a Gateway, Helicone offers a suite of both middleware and advanced features such as caching, prompt thread detection and vaults to securely share API keys.
...
**→ <a href="https://www.helicone.ai/" target="_blank">Start for free</a>**
...
Phoenix by <a href="https://www.helicone.ai/blog/best-arize-alternatives" rel="noopener noreferrer nofollow" target="_blank">Arize AI</a> is known for its strong focus on machine learning model monitoring and explainability.
...
### What is <a href="https://www.helicone.ai/blog/best-langfuse-alternatives" target="_blank">Langfuse</a>?

Langfuse is an open-source LLM Engineering Platform that helps to trace & debug LLM models.
...
HoneyHive AI evaluates, debugs, and monitors production LLM applications. It lets you trace
execution flows, customize event feedback, and create evaluation or fine-tuning datasets
...
OpenLLMetry is an open-source framework developed by **Traceloop**, that simplifies the
...
observability platforms and backends like <a href="https://docs.kloudmate.com/openllmetry-opentelemetry-based-observability-for-llms" rel="noopener nofollow" target="_blank">KloudMate</a>.
...
#### So, which LangSmith alternatives suits you better?
