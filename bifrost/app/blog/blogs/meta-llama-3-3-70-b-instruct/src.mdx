...
## Integrate Gemini-Exp-1206 with Helicone ⚡️

Helicone is an open-source observability tool that helps you monitor, debug and improve your `Gemini-Exp-1206` powered AI apps.

Integrate with a few lines of code in JavaScript:
...
Please see detailed integration docs for JavaScript, Python and more <a href="https://docs.helicone.ai/integrations/gemini/api/javascript" target="_blank" rel="noopener">here</a>.
...
Helicone is an open-source observability tool that helps you monitor, debug and improve your Llama-powered AI apps.

Integrate with a few lines of code NodeJS:
...
Please see Helicone's <a href="https://docs.helicone.ai/getting-started/integration-method/custom#custom-model-integration" target="_blank" rel="noopener">custom model integration docs</a> for details.
