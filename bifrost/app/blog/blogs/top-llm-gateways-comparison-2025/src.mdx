...
| ----------------------------------------------- | --------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ---------------------- | ------------------------------------------------------------------------------------------ |
| **Routing Strategy**                            | Latency, weighted, cost-aware, use-case dependent; **All health-aware**                               | Latency, cost-aware, weighted, tag-based; health-aware                           | Cost-aware, weighted, region-aware;  | latency, cost, weighted, least-busy;      | Intelligent routing, load balancing, cost-aware | Quality, latency, cost, constraint-based              |
...
| **Language & Runtime**                          | Rust (super fast)                                                                             | Python/TypeScript                                                                | Python                                                                | Python/TypeScript                                                                                   | Python/Go/Java/.NET | Python                                                                                     |
| **Supported Providers**                         | 100+ models and 25+ providers inluding OpenAI, Anthropic, Google, Bedrock, etc.<br/> Custom models                                                                            | 400+ models and providers                                                                        | 100+ models                                                    | All major + custom                                                                                  | 250+ LLM providers (OpenAI, Anthropic, Google, etc.) | All major + custom                                                                         |
...
| **Unified API**                                 | ✅                                                                                            | ✅                                                                               | ✅                                                                    | ✅                                                                                                  | ✅ | ✅                                                                                         |
| **Caching**                                     | In-memory & Redis-based caching with intelligent strategies and scopes  | Provider-native (varies by provider)  | Built-in Simple & Semantic caching  | In-memory & Redis | Built-in intelligent caching | Client-side file-based with per-query control |
...
![TrueFoundry AI Gateway Logo](/static/blog/top-llm-gateways-comparison-2025/truefoundry-logo.webp)
