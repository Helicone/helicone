...
<BottomLine
  title="Flash Update 💡"
  description="Google just announced that Gemini 2.5 Flash is coming soon—bringing even lower latency and greater cost-efficiency than the already-cheap-and-fast Gemini 2.5 Pro."
/>
...
<video width="100%" controls autoplay loop className="rounded-xl">
  <source
    src="https://marketing-assets-helicone.s3.us-west-2.amazonaws.com/gemini-hexagon.mp4"
    type="video/mp4"
  />
...
1. <a href="https://gemini.google.com/">Gemini App</a>: The simplest way to
   access Gemini 2.5 Pro, available on mobile/web.
2. <a
     href="https://ai.google.dev/gemini-api/docs/models#gemini-2.5-pro-preview-03-25"
     target="_blank"
     rel="noopener"
   >
     Gemini API
   </a>
   : For developers. Use model string `gemini-2.5-pro-preview-03-25`.
3. <a href="https://aistudio.google.com/">Google AI Studio</a>: Fastest way to
   test and experiment with Gemini for free.
...
- <a
    href="https://www.helicone.ai/blog/gemini-2.0-flash"
    target="_blank"
    rel="noopener"
  >
