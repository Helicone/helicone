...
<FAQ 
  items={[
    ...
    {
      question: "Is Grok 3 free?",
      answer: "No. You need an X Premium Plus subscription or a Grok app subscription to access it.<br/><br/>Update: As of February 19, Grok 3 is free for a short while. See the <a href=\"https://x.com/xai/status/1892400129719611567\" target=\"_blank\" rel=\"noopener\">official announcement</a> for more details."
    },
    {
      question: "When will the Grok API be available?",
      answer: "xAI plans to release it within the next few weeks."
    },
    {
    ...
    {
      question: "Will xAI open-source Grok 3?",
      answer: "No confirmation yet, but Grok 1 is open-source so it's a possibility."
    }
  ]}
/>
