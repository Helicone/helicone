...
| **Pricing** | Professional plan ($79/mo) | Pro subscription ($200/mo) | Pro subscription ($200/mo) | Uses Claude API pricing ($3/M input, $15/M output) | Free (self-hosted) or $0.05/step (Cloud) |
