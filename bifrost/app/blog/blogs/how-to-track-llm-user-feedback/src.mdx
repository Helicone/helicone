...
A recent study done by <a href="https://arxiv.org/html/2504.05522v2" target="_blank" rel="noopener">Google DeepMind</a> in April 2025 have shown that aligning LLM outputs with user feedback lead to a significant increase in positive user interactions, as evidenced by a larger positive playback rate gain. 

Recent studies also show thta it leads to more efficient customer service operations, with a <a href="https://www.gorgias.com/blog/automation-impact-on-cx-data" target="_blank" rel="noopener">52% faster resolution</a> of support tickets, according to Gorgias's blog, and a <a href="https://assets.kpmg.com/content/dam/kpmg/nl/pdf/2024/services/global-cee-report-2023-24.pdf" target="_blank" rel="noopener">30% reduction in operational costs</a>, according to KPMG's Global CEE Report 2023-24.
...
For more nuanced feedback collection, <a href="https://docs.helicone.ai/features/advanced-usage/custom-properties" target="_blank" rel="noopener">Custom Properties</a> provide a flexible way to attach custom metadata to your LLM requests. 
...
Monitor your users' interactions with your AI models to gain deeper insights into usage patterns and their satisfaction levels. 

Similar to custom properties, you can add a Helicone auth-header (if you haven't already), then a header for the user you want to track:
...
With <a href="https://docs.helicone.ai/features/advanced-usage/user-metrics" target="_blank" rel="noopener">user metrics</a> tracking, you can:
...
This user-level data can provide you with the **context and granularity** to interpret the feedback you collect and prioritize improvements that benefit your most valuable users.

<BottomLine
  title="Pro Tip 💡"
  description="Combine multiple Custom Properties to create rich feedback datasets. For example, combining user role, feature used, and satisfaction rating gives you powerful insights into which features work best for different user segments."
/>

## Turning User Feedback into Training Datasets

Once you've collected sufficient feedback, you can transform it into valuable training data for improving your LLM applications.

### 1. Exporting and Filtering Your Feedback Data
...
This specialized dataset of real-world interactions can now be exported from Helicone's dashboard or API to drive meaningful, targeted improvements.
...
### 3. Creating Specialized Training Datasets

Based on your analysis, create specialized datasets tailored to your specific improvement goals:

<video width="100%" controls autoplay loop>
  <source
    src="/static/blog/custom-properties/dataset-creation-helicone.mp4"
    type="video/mp4"
  />
  Your browser does not support the video tag.
</video>

<a href="https://docs.helicone.ai/features/fine-tuning#datasets-and-fine-tuning" target="_blank" rel="noopener">Datasets</a> in Helicone can be created via the intuitive UI or programmatically for more advanced use cases.

## Success Stories of User Feedback Implementation

### Subscription-Based Feedback Segmentation
...
<CallToAction
  ...
  primaryButtonText="Start Collecting Feedback"
...
- <a
    ...
    rel="noopener"
  >
    Doc: User Feedback API Documentation
  </a>
- <a
