...
No, Claude Code cannot directly access external resources. It can only interact with your local filesystem and run commands with your permissions.

### How does token usage compare to using Claude in a web interface?

Claude Code typically uses more tokens because it needs to process larger amounts of context from your codebase.
