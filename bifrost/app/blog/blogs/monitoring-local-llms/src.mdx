...
- <a href="https://www.docker.com/get-started/" target="_blank" rel="noopener">
    Docker
  </a>
  installed
...
<em>
  — You can find a{" "}
  <a
    href="https://github.com/juliettech13/helicone-ollama-proxy"
    target="_blank"
    rel="noopener"
  >
    finished version of the codebase here
  </a>
  . Feel free to clone it locally and skip to the last step of this section.
</em>
