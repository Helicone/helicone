...
- Compatible with various AI models and APIs. Here's the entire <a href="https://docs.helicone.ai/getting-started/integration-method/gateway" target="_blank" rel="noopener">list of integrations</a>.
...
1. Add custom headers to your requests using this format: `Helicone-Property-[Name]: [value]` where `Name`is the name of your custom property. For example:
   ...
   More info about Custom Properties in the <a href="https://docs.helicone.ai/features/advanced-usage/custom-properties" target="_blank" rel="noopener">docs</a>.

2. Now you can segment incoming requests on the **Dashboard**, **Requests**, or **Properties** page. For example:

- **Use case 1:** Filter for specific prompt chains on <a href="https://us.helicone.ai/requests" target="_blank" rel="noopener">Requests</a> page to analyze costs and latency.
  ![Filter by custom properties on Helicone's Request page](/static/blog/4-essential-features/request-page.webp)
- **Use case 2:** Analyze "unit economics" (e.g., average cost per conversation) on <a href="https://us.helicone.ai/properties" target="_blank" rel="noopener">Properties</a> page.

  ![Analyze unit economics using custom properties in Helicone](/static/blog/4-essential-features/properties-page.webp)

- **Use case 3:** Filter for all requests that meet a criteria on <a href="https://us.helicone.ai/dashboard" target="_blank" rel="noopener">Dashboard</a> page.
...
- **Docs:** <a href="https://docs.helicone.ai/features/advanced-usage/custom-properties" target="_blank" rel="noopener">Custom Properties</a>
- **Advanced:** <a href="https://www.helicone.ai/blog/custom-properties" target="_blank" rel="noopener">How to understand your users better and deliver a top-tier experience with Custom Properties</a>
...
1. Add the following three headers to your requests. Here's the doc on <a href="https://docs.helicone.ai/features/sessions" target="_blank" rel="noopener">how to enable Sessions</a>.
...
- **Docs:** <a href="https://docs.helicone.ai/features/sessions" target="_blank" rel="noopener">Sessions</a>
...
1. Set up Helicone in proxy mode. Use one of the methods in the <a href="https://docs.helicone.ai/getting-started/quick-start#quick-start" target="_blank" rel="noopener">Starter Guide</a>.
...
3. Assign a unique ID to your prompt using a header. Here's the doc on <a href="https://docs.helicone.ai/features/prompts" target="_blank" rel="noopener">Prompt Management & Experiments</a>. For example:
...
- **Docs:** <a href="https://docs.helicone.ai/features/prompts" target="_blank" rel="noopener">Prompts & Experiments</a>
- **Blog:** <a href="https://www.helicone.ai/blog/prompt-management" target="_blank" rel="noopener">Choosing a prompt management tool | Helicone</a>
- **Blog:** <a href="https://docs.helicone.ai/use-cases/experiments" target="_blank" rel="noopener">How to run LLM Prompt Experiment | Helicone</a>
...
2. Customize caching behavior. For detailed description on how to configure the headers, visit the <a href="https://docs.helicone.ai/features/advanced-usage/caching" target="_blank" rel="noopener">doc</a>.
...
Join our <a href="https://discord.gg/2TkeWdXNPQ" target="_blank" rel="noopener">Discord</a> or <a href="mailto:help@helicone.ai" target="_blank" rel="noopener">email us</a>!
