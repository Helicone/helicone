...
- Compatible with various AI models and APIs. Here's the <a href="https://docs.helicone.ai/getting-started/integration-method/gateway" target="_blank">list of integrations</a>.
- Easily switch between models (e.g., GPT-4 to LLaMA) by updating the base URL.
...
Custom Properties allow you to tailor Helicone’s analytics to your specific needs. By **<span style={{color: '#0ea5e9'}}>segmenting requests</span>**, you can make more informed decision and targeted optimizations. 
...
1. Add custom headers to your requests using this format: `Helicone-Property-[Name]: [value]` where `Name`is the name of your custom property. Here's the <a href="https://docs.helicone.ai/features/advanced-usage/custom-properties" target="_blank">doc</a>. For example:  
...
2. Use these properties to segment and analyze your requests on the **Dashboard**, **Requests**, or **Properties** page. For example: 

  - **Use case 1:** Track costs and latency for specific prompt chains on <a href="https://us.helicone.ai/requests" target="_blank">Requests</a> page.
  ...
  - **Use case 3:** View metrics related to a subset of requests that meet a criteria on <a href="https://us.helicone.ai/dashboard" target="_blank">Dashboard</a> page.
...
- Analyze behaviours and patterns between free and paid users
...
- Implement tracing with just two headers
...
Helicone aims to provide all the essential tools to make data-driven improvements, resolve bottlenecks, and deliver better AI experiences. Interested in checking out other features? Here's a <a href="https://docs.helicone.ai/helicone-headers/header-directory" target="_blank">list of headers</a> to get you started. Happy optimizing!
