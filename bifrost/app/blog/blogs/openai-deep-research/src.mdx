<BottomLine
  title="OpenAI Update 💡"
  description="As of April 2, 2025, Deep Research is now available to all ChatGPT Plus, Teams, Edu, and Enterprise users, with rumored plans to roll out to Free users in the near future."
/>
...
According to <a href="https://openai.com/index/introducing-deep-research/" target="_blank" rel="noopener">OpenAI's official results</a>, the Deep Research model outperforms previous models on key benchmarks.
...
For example, while GPT-4 equipped with plugins scores `15%`, human respondents achieved `92%`, highlighting a significant gap in AI performance on practical, reasoning-based tasks.
...
Let's compare OpenAI Deep Research vs Gemini Deep Research and the newly launched Perplexity Deep Research in February 2025.
...
### Detailed Comparison: OpenAI Deep Research Pricing & Features Comparison
...
Is OpenAI's Deep Research cost worth paying? Well that depends on what you're looking for.
...
While OpenAI's Deep Research's price is steep, OpenAI has made it available to Plus users and plans to bring it to Free tier users in the near future. 
...
As of February 25, 2025, OpenAI <a href="https://x.com/OpenAI/status/1894454194943529433" target="_blank" rel="noopener"> announced</a> that Deep research is available to all ChatGPT Pro, Plus, Teams, Edu and Enterprise users.

To start, Plus, Team, Enterprise, and Edu users have 10 deep research queries/month.

Pro users now have 120 deep research queries/month.

OpenAI is <a href="https://www.gadgets360.com/ai/news/openai-chatgpt-deep-research-expansion-ai-agent-free-tier-8067428" target="_blank" rel="noopener">said</a> to be bringing Deep Research to Free users in the near future, as promised. 

Please check OpenAI's website for the latest updates.

## Free Alternative to OpenAI Deep Research

For those thinking $200/month is too much, there are a few open-source/free alternatives to OpenAI Deep Research:
...
2. An open-source alternative to OpenAI Deep Research called <a href="https://github.com/dzhng/deep-research" target="_blank" rel="noopener">Open Deep Research</a> already getting over 10k stars on GitHub.
  ...
  items={[
    {
      ...
      answer: "Deep Research typically takes 5–30 minutes per query, depending on the complexity of the topic and the amount of data it processes."
    },
    {
      question: "What kind of data can Deep Research access?",
      answer: "It can browse the open web and analyze uploaded files but cannot access private, subscription-based, or internal resources yet, though that feature is in the works."
    },
    {
      question: "When should I use Deep Research vs. Search?",
      answer: "Use Search for quick facts, news, weather, or summaries (instant results). Use Deep Research for in-depth analysis, requiring multiple sources and structured reports (longer processing time)."
    },
    {
      question: "How do I use Deep Research?",
      answer: "In ChatGPT, select 'Deep Research' and enter your query. Attach files, images, or spreadsheets for more context. Deep Research may ask follow-up questions for clarity. It runs in the background, analyzing data and compiling a structured report."
    },
    {
      question: "Can I use Helicone to track Deep Research usage?",
      answer: "Currently, OpenAI Deep Research API is unavailable, so no. However, Helicone can be used to track other AI-powered research models like Open Deep Research, OpenAI's API-based models, and self-hosted LLMs."
    }
  ]}
/>
