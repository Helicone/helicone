...
Go to [Helicone](https://us.helicone.ai/settings/api-keys) and get your Helicone API key.
...
- **Provider keys:** You can use Helicone's auth or bring your own keys. To BYOK, you can set up your provider keys to the [Helicone dashboard](https://helicone.ai/providers).
