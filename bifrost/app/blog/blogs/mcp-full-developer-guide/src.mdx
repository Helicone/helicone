...
MCP provides a universal interface for AI applications to interact with various systems while maintaining security and user control.
...
<BottomLine
  title="Why Does MCP Even Exist❓"
  description="Before MCP, developers had to build custom integrations from scratch whenever they wanted LLMs to access external systems (files, APIs, databases). Each implementation was different, required significant code, and wouldn't work with desktop apps. MCP provides a standardized framework for these integrations that works consistently across implementations, with a common communication protocol between systems and AI tools."
/>

At its core, MCP follows a client-server architecture with three main components:
...
For instance, in a workflow using Claude to analyze company sales data stored in a PostgreSQL database:

- The **host** is the Claude Desktop app
- The **client** is the MCP client module within Claude Desktop that manages connections to MCP servers, while 
...
- **Resources**: File-like data that LLMs can read (API responses, file contents)
- **Tools**: Functions that LLMs can call to perform actions
- **Prompts**: Pre-written templates that help users accomplish specific tasks

<BottomLine
  title="MCP vs Function Calling: Understanding the Difference 💡"
...
## Getting Started with MCP: The Basics

Let's set up a simple MCP configuration with Claude Desktop to access both file system capabilities and web search.

### Step 1: Install Claude Desktop

<a href="https://claude.ai/download">Download</a> and install Claude Desktop.
...
## Building MCP Servers with Cloudflare Workers—Easiest Way to Build your Own MCP Server

Cloudflare Workers offer a simplified approach to building MCP servers. Let's create an image generation server using Cloudflare.
...
### Step 4 (Optional): Configure Claude Desktop
...
<a href="https://modelcontextprotocol.io" target="_blank" rel="noreferrer">View the full documentation</a> for more information on configuring MCPs with other Clients, such as Cursor.
...
## How to Create MCP Clients

Building an MCP client allows you to create a custom application to connect to MCP servers. 

For detailed instructions, visit <a href="https://modelcontextprotocol.io/quickstart/client" target="_blank" rel="noreferrer">Anthropic's official guide</a> to learn how to build a client in Python, NodeJS, or Java.
...
| **MCP** | **Description** | **Example Commands** |  
|---------|---------------|---------------------|  
| <a href="https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem" target="_blank" rel="noreferrer"><strong>FileSystem</strong></a> | Access and manipulate files securely. | - "Create a summary of the text files in my project folder." <br/> - "Find all Python files containing database connections." |  
| <a href="https://github.com/modelcontextprotocol/servers/tree/main/src/github" target="_blank" rel="noreferrer"><strong>GitHub Integration</strong></a> | Access repositories and manage issues. | - "Find all open issues related to authentication in my repository." <br/> - "Show me the recent commits to the main branch." |  
| <a href="https://github.com/modelcontextprotocol/servers/tree/main/src/postgres" target="_blank" rel="noreferrer"><strong>Database Integration</strong></a> | Query databases securely. | - "Show me the schema of the users table." <br/> - "Find all customers who made purchases in the last month." |  

### Where to Find MCPs

Here are a few great sources to find MCPs for your LLM applications:

- Visit the <a href="https://modelcontextprotocol.io/examples" target="_blank" rel="noreferrer">Example Servers</a> page on the MCP website for a curated list of implementations.
- Many TypeScript MCP servers are available directly via <a href="https://www.npmjs.com/" target="_blank" rel="noreferrer">NPM</a> with the pattern `@modelcontextprotocol/server-*`.
- Python implementations often follow the naming convention `mcp-server-*` on <a href="https://pypi.org/" target="_blank" rel="noreferrer">PyPI</a>.
...
- <a href="http://smithery.ai/" target="_blank" rel="noreferrer">Smithery.ai</a> offers a directory of MCP servers and tools for AI development. {/* This was down for me, couldnt access it */}
- <a href="https://cursor.directory/" target="_blank" rel="noreferrer">Cursor Directory</a> offers a collection of MCPs specifically designed for Cursor IDE.
- <a href="https://lmsystems.ai/marketplace" target="_blank" rel="noreferrer">LM Systems Marketplace</a> offers a collection of MCP servers and tools.

## How to Debug and Troubleshooting MCPs

Here are a few tips for <a href="https://modelcontextprotocol.io/docs/tools/debugging" target="_blank" rel="noreferrer">debugging MCP servers</a>:
...
<CallToAction
  title="Easily Debug AI Agents with Helicone ⚡️"
