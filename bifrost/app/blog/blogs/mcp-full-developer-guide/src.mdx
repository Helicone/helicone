...
<TableOfContents excludeHeadings={["Table of Contents", "What is the difference between MCP vs function calling? 💡", "💡 Hot tip: Let LLMs do the heavy lifting", "Easily Debug LLM Workflows with Helicone ⚡️", "Conclusion", "Frequently Asked Questions"]} maxLevel={2} />
