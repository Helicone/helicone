...
![Helicone listening to events during onboarding to make sure everything is integrated correctly.](https://marketing-assets-helicone.s3.us-west-2.amazonaws.com/listening-for-events.gif)
...
**→ This is a useful article on [how to use custom properties](https://www.helicone.ai/blog/how-to-track-llm-user-feedback).**
...
- **Use the docs, and join <a href="https://discord.gg/hFUtEafSNr" target="_blank" rel="noopener noreferrer">Discord</a>!** But if the docs are unclear, please let us know.
