...
Use delimiters like triple quotation marks, XML tags, or section titles to clearly define distinct sections of the input. This makes it easier for the model to interpret the information correctly.
...
If <a href="https://www.helicone.ai/blog/openai-structured-outputs" target="_blank" rel="noopener">structured output</a> is critical, you’re better off using a standard LLM instead of a thinking model.
