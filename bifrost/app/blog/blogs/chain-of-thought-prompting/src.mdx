...
![Chain-of-Thought Prompting - Helicone](/static/blog/chain-of-thought/cover.webp)
...
We've discussed how Chain-of-Thought (CoT) prompting can improve reasoning and the output of Large Language Models. We've also provided some real-life examples of how this approach works.
...
- Experiment with zero-shot or few-shot CoT in your own projects. See if the output can be improved.
...
- **<a href="https://docs.helicone.ai/guides/prompt-engineering/overview" target="_blank">Other Prompt Engineering Techniques - Helicone</a>**
