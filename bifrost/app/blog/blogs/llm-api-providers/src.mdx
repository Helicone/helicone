...
| [OpenRouter](#3-openrouter) | _Varies by routing_  | _Depends on provider_ | _Depends on provider_ | _Depends on provider_ |
| [Hyperbolic](#4-hyperbolic) | $2.00 / $2.00 🥉 | 23/s | - | 131k |
| [Replicate](#5-replicate) | $3.75 / $10.00 | - | - | 64k |
| [HuggingFace](#6-huggingface) | _Self-hosted (compute cost)_ | _Depends on hardware_ | _Depends on hardware_ | 128k |
...
| [Anyscale](#10-anyscale) | _Self-hosted (compute cost)_ | _Depends on hardware_	 | _Depends on hardware_ | 64k–128k |
