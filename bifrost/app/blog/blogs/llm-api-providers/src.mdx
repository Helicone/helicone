...
<CallToAction
  title="Ready to Ship Your AI App? ⚡️"
  description="Your app is built, but shipping to production requires monitoring. Join thousands of developers who use Helicone to track costs, debug prompts, and catch issues before users do."
  primaryButtonText="Start Monitoring For Free"
  primaryButtonLink="https://www.helicone.ai/signup"
  secondaryButtonText="Calculate Potential Savings"
...
Pay-as-you-go and subscription <a href="https://openrouter.ai/models" target="_blank">plans</a>. Get started <a href="https://openrouter.ai/docs/quick-start" target="_blank">here</a>.
...
Usage-based and subscription <a href="https://www.lepton.ai/pricing" target="_blank" rel="noopener">plans</a>. The free plan currently supports up to 48 CPUs + 2 GPUs concurrently, while each serverless endpoint costs by 1 million tokens. Get started <a href="https://www.lepton.ai/docs/overview/quickstart" target="_blank">here</a>.
