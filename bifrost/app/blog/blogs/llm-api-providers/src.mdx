...
**<span style={{color: '#0ea5e9'}}><a href="https://docs.together.ai/docs/quickstart/" target="_blank">Free to start</a></span>**. For serverless models, pay for what you use (per token/image). For running models on your own private GPU, it’s a pay-per-second usage model. Enterprise tiers available.
