...
1. [Together AI](#1-togther-ai)
2. [Fireworks AI](#2-fireworks-ai)
3. [OpenRouter](#3-openrouter)
4. [Hyperbolic](#4-hyperbolic)
5. [Replicate](#5-replicate)
6. [Hugging Face](#6-hugging-face)
7. [Groq](#7-groq)
8. [DeepInfra](#8-deepinfra)
9. [Perplexity AI](#9-perplexity-ai)
10. [Anyscale](#10-anyscale)
...
### Integrating LLM observability with Together AI
...
### Integrating LLM observability with Fireworks AI
...
### Integrating LLM Observability with OpenRouter
...
### Integrating LLM Observability with Hyperbolic
...
### Integrating LLM observability with Replicate
...
# switch to new endpoint with Helicone
gateway.helicone.ai/v1/predictions
...
### Integrating LLM observability with HuggingFace
...
### Integrating LLM Observability with Groq
...
### Integrating LLM Observability with DeepInfra
...
### Integrating LLM observability with Perplexity AI
...
# switch to new endpoint with Helicone
gateway.helicone.ai/chat/completions
...
### Integrating LLM Observability with AnyScale
