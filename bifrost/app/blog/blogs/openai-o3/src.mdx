...
OpenAI CEO Sam Altman <a href="https://x.com/sama/status/1908167621624856998" target="_blank" rel="noopener">announced</a> on April 4, 2025 that the company will release both o3 and a newly announced **o4-mini** in "a couple of weeks," while delaying GPT-5 until "a few months" later. 

Originally, o3's reasoning capabilities were expected to be integrated into GPT-5, but OpenAI has pivoted to releasing both models separately.

![OpenAI o3 released](/static/blog/openai-o3/o3-cover.webp)

The delay in GPT-5 is reportedly to make it "much better than originally thought" while addressing integration challenges.
...
Integrate LLM observability with a few lines of code. See [docs](https://docs.helicone.ai/integrations/openai/javascript) for details.
...
We, for one, are quite excited to see what's in stock!

### Other models you might be interested in:

- [Everything you need to know about OpenAI's o1 and ChatGPT Pro](https://www.helicone.ai/blog/openai-o1-and-chatgpt-pro)
- [Meta's Llama 3.3 — Benchmarks, features & comparison with GPT-4 or Claude-Sonnet-3.5](https://www.helicone.ai/blog/meta-llama-3-3-70-b-instruct)
- [GPT-5: release date, features & what to expect](https://www.helicone.ai/blog/openai-gpt-5)
