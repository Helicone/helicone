...
<CallToAction
  title="Track your o3 usage before costs spiral 🌀"
  description="Get real-time visibility into o3 performance, token usage, and costs—before your experiments break the bank. Monitor all OpenAI models (including o3, o3-mini, and upcoming o4-mini) with a single integration."
  primaryButtonText="Set Up in 30 Seconds"
  primaryButtonLink="https://docs.helicone.ai/integrations/openai/javascript"
  secondaryButtonText="See Usage in Dashboard"
  secondaryButtonLink="https://helicone.ai/demo"
/>
...
<CallToAction
  title="One o3 token costs 15x more than GPT-4 😳"
  description="Don't get hit with a $30K bill. Monitor every o3 and o4-mini request in real-time, catch runaway costs before they happen, and optimize your prompts for maximum efficiency—all with one line of code."
  primaryButtonText="Track Your LLM Spend"
  primaryButtonLink="https://docs.helicone.ai/integrations/openai/javascript"
  secondaryButtonText="See Live Cost Dashboard"
  secondaryButtonLink="https://helicone.ai/demo"
/>
