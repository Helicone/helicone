...
If you're building with AI, and are looking for a plug-and-play tool to improve your output and cost without installing any SDKs, let us show you an **<span style={{color: '#0ea5e9'}}>open-source, lightweight, and potentially cheaper alternative - Helicone</span>**.

In the following section, we will go over the best practices when building with AI.
...
### Try Helicone for free.
    ...
    <a href="https://www.helicone.ai/" target="_blank" rel="noopener">Sign up</a> or <a href="https://www.helicone.ai/contact" target="_blank" rel="noopener">contact us</a>.
