...
## Monitoring Applications Powered by DeepSeek V3

Connect DeepSeek with Helicone to get powerful observability for your LLM application. Integration is easy, follow these steps:

### 1. Create a Helicone API Key

Create a <a href="https://helicone.ai" target="_blank" rel="noopener">Helicone</a> account, then <a href="https://us.helicone.ai/developer" target="_blank" rel="noopener">generate an API key</a>.

### 2. Create a DeepSeek API Key

Create a <a href="platform.deepseek.ai" target="_blank" rel="noopener">DeepSeek</a> account, then generate an API key.

### 3. Set both API keys as environment variables
...
### 4. Modify the base URL and add Auth headers

Replace your base URL with the Helicone Gateway URL:
...
For details, please refer to the <a href="https://docs.helicone.ai/getting-started/integration-method/deepseek" target="_blank" rel="noopener">DeepSeek integration documentation</a>.
