...
This caused big tech companies to lose hundreds of billions in market cap with NVIDIA [suffering](https://www.datacenterdynamics.com/en/news/nvidia-records-largest-market-cap-loss-in-us-history-as-deepseek-wipes-out-600bn/#:~:text=Nvidia's%20share%20price%20fell%20some,off%20the%20GPU%20company's%20valuation.) the worst single-day market cap loss in stock market history. Even Sam Altman, CEO of OpenAI, began to [wax poetic](https://x.com/sama/status/1883185690508488934) on X. 
...
Using Helicone, you can test and transition to `DeepSeek V3` or `R1` safely without disrupting your users. This article will walk you through the process.

### DeepSeek R1 vs. the Competition
| Model                  | Cost per 1M Tokens (Input) | Cost per 1M Tokens (Output) | Max Context Tokens | Max Output Tokens | Performance |
|------------------------|--------------------------|---------------------------|--------------------|------------------|-------------|
...
- Have a Helicone account. Sign up for free [here](https://us.helicone.ai/signup).
- Have at least 10 logs in your Helicone project.
- Use Helicone's prompt templating feature. Learn more [here](https://docs.helicone.ai/features/prompts).
...
<CallToAction
  title="Compare models' performance with Helicone"
