...
Start by choosing an observability tool. **Helicone** has a generous <a href="https://helicone.ai/pricing" target="_blank" rel="noopener">free tier</a> and it's easy to set up.

Next, <a href="https://docs.helicone.ai/integrations/gemini/api/javascript" target="_blank" rel="noopener">follow the instruction to integrate</a> your Gemini-powered AI app. If you choose to use Helicone, this step takes about a minute.

![Integrating Gemini-2.0 powered AI app with Helicone](/static/blog/gemini-2.0-flash/listen-for-events.webp)
...
![Track request and response logs for Gemini-2.0 powered AI app with Helicone](/static/blog/gemini-2.0-flash/requests.webp)
...
As LLMs are sensitive to model and prompt changes, use Helicone's <a href="https://docs.helicone.ai/features/experiments" target="_blank" rel="noopener">Experiments feature</a> to test and compare different versions of your prompts.
...
![Compare different versions of your prompt with Helicone](/static/blog/gemini-2.0-flash/experiments.webp)
...
![Merge PR in GitHub](/static/blog/gemini-2.0-flash/merge.webp)
...
![Helicone dashboard](/static/blog/gemini-2.0-flash/dashboard.webp)
