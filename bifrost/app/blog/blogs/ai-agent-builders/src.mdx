...
3. Create your LlamaIndex agent.

- All LLM calls made by these agents will be automatically logged and monitored by Helicone. Use the dashboard to view logs, analyze performance, and optimize your AI agents.
- See <a href="https://docs.helicone.ai/integrations/openai/llamaindex#llamaindex-integration" target="_blank" rel="noopener">LlamaIndex Integration docs</a> for details.
...
3. Create and run your CrewAI agent.

- Helicone will automatically log and monitor all LLM calls made by the agent. Use the dashboard to view logs, analyze performance, and optimize your AI agents.
- See <a href="https://docs.helicone.ai/getting-started/integration-method/crewai#crew-ai-integration" target="_blank" rel="noopener">CrewAI Integration docs</a> for details.
