...
## Best Open-source Tools for Building AI Agents in 2025
...
<CallToAction
  title="Add Observability to Your AI Agents in Minutes ⚡️"
  description="Simply add one line of code to get full observability into your AI agent's decisions, costs, and performance. Helicone is compatible with Dify, AutoGen, LangChain, and all major agent frameworks."
