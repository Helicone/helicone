...
### Integrating LLM Observability with LlamaIndex

Generate a write-only API key in Helicone. Then set the `OPENAI_API_BASE` environment variable as follows:

```python
os.environ["OPENAI_API_BASE"] = f"https://oai.helicone.ai/{HELICONE_API_KEY}/v1"
```

All LLM calls made by these agents will be automatically logged and monitored by Helicone. See <a href="https://docs.helicone.ai/integrations/openai/llamaindex#llamaindex-integration" target="_blank" rel="noopener">LlamaIndex Integration docs</a> for details.
...
Helicone will automatically log and monitor all LLM calls made by the agent. See <a href="https://docs.helicone.ai/getting-started/integration-method/crewai#crew-ai-integration" target="_blank" rel="noopener">CrewAI Integration docs</a> for details.
...
Generate a `write-only` API key in Helicone. Then modify your LangChain OpenAI configuration to use Helicone:
...
All LLM calls made by the agent will be automatically logged and monitored by Helicone. See <a href="https://docs.helicone.ai/integrations/openai/langchain" target="_blank" rel="noopener">OpenAI LangChain docs</a> or <a href="https://docs.helicone.ai/integrations/anthropic/langchain" target="_blank" rel="noopener">Anthropic LangChain docs</a> for details.
