...
<FAQ items={[
  ...
  },
  {
    ...
    answer: "o1 is OpenAI's most expensive model, costing $150 per million input tokens and $600 per million output tokens."
  },
  {
  ...
  {
    question: "What features are coming next for o1?",
    answer: "OpenAI plans to continuously improve o1, adding function calling capability, web browsing, file uploads, and other performance improvements. For developers, o1 support will be available in the API with features like function calling, developer messages, structured outputs, and vision."
  },
  {
