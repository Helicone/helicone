...
According to recent statements, GPT-5 is expected to be **released in early 2025**, here's <a href="https://www.helicone.ai/blog/openai-gpt-5" target="_blank">everything you need to know about gpt-5 and what to expect</a>.
...
- Over the next five years, OpenAI intends to "aggressively raise" the cost of ChatGPT Plus, it is expected to reach $44 per month by 2029, according to <a href="https://www.nytimes.com/2024/09/27/technology/openai-chatgpt-investors-funding.html" target="_blank">a report by New York Times</a>.
