...
```bash
# change the endpoint to helicone
https://gateway.helicone.ai/v1beta/models/model-name:generateContent?key=${process.env.GOOGLE_GENERATIVE_API_KEY}
...
Please see detailed integration for JavaScript, Python and more in <a href="https://docs.helicone.ai/integrations/gemini/api/javascript" target="_blank" rel="noopener">documentation</a>.
