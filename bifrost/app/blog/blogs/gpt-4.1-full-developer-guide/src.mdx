...
- **API-only release**: Unlike previous models, GPT-4.1 is exclusively available <a href="https://platform.openai.com/docs/models/gpt-4.1" target="_blank" rel="noopener">through the API</a>, not in ChatGPT's interface. _GPT-4.1 was eventually released in ChatGPT in May 2025_.
...
**UPDATE**: GPT-4.1 was released in ChatGPT in May 2025, so you can access it in the <a href="https://chat.openai.com/" target="_blank" rel="noopener">ChatGPT interface</a> as well.
...
<FAQ
  items={[
    ...
    },
    {
      ...
      answer: "Yes, GPT-4.1 is now available in ChatGPT."
    },
    {
