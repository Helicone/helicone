...
- **API-only release**: Unlike previous models, GPT-4.1 is exclusively available <a href="https://platform.openai.com/docs/models/gpt-4.1" target="_blank" rel="noopener">through the API</a>, not in ChatGPT's interface. *GPT-4.1 was eventually released in ChatGPT in May 2025*.
