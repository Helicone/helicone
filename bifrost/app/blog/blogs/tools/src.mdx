...
<CallToAction
  title="Ready to Build Production AI Agents?"
  description="Join our 7-day email course and learn to build, monitor, and deploy AI agents with proper tool calling, observability, and real-world best practices."
  primaryButtonText="Start the Course"
  primaryButtonLink="/agent-course"
  secondaryButtonText="View Curriculum"
  secondaryButtonLink="/agent-course#course-overview"
/>
...
Our [7-day AI agent email course](/agent-course) walks you through building a production-ready agent with proper tool calling, observability, and deployment - complete with working code examples and best practices.
