...
According to recent statements, GPT-5 is expected to be **released in early 2025**. In the meantime, <a href="https://wccftech.com/openai-ceo-says-no-gpt-5-in-2024/" target="_blank">OpenAI will be focusing on GPT-o1</a>, previously codenamed "Project Strawberry", which has just been released on December 5.
...
| ------------------------------------------------- | --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **GPT-5**                                         | **Expected early 2025**                                        | Expected to bring advanced reasoning, improved reliability, and autonomous AI agents capable of handling real-world tasks without human oversight.                                    |
