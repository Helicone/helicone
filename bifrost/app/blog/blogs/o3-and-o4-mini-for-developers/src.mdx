...
- **Full tool access**: Unlike previous reasoning models, o3 and o4-mini can use _every_ tool within ChatGPT—web search, Python, image analysis, file interpretation, and image generation.
...
- <a
    ...
    rel="noopener"
  >
    GPT-4.1 Released: Benchmarks, Performance, and How to Safely Migrate to
    Production
  </a>
- <a
