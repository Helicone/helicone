OpenAI just dropped their latest models: **o3** and **o4-mini**. 

These aren't just incremental updates—they represent a significant shift in how AI tools can reason and use tools autonomously. 
...
![OpenAI o3 and o4-mini](/static/blog/openai-o3/o3-cover.webp)

Let's explore these models and see how you can start using them in your live apps right away!
...
- **Agentic capabilities**: These models can make dozens or even hundreds of tool calls in sequence, thinking through complex problems step by step. You'd wanna **keep a close eye** on token use with Helicone.
...
<BottomLine
  title="Key Difference from Previous Models 💡"
...
It gets even more interesting when you add tools to the mix:
...
Enough numbers, let's see what these guys can actually do.

### "Thinking with Images"

<video width="100%" controls autoplay loop>
  <source
    src="/static/blog/o3-and-o4-mini-for-developers/Thinking with Images.mp4"
    type="video/mp4"
  />
...
![o3 zooming into image](/static/blog/o3-and-o4-mini-for-developers/zooming_into_image.jpeg)

_Source: <a href="https://x.com/danshipper/status/1912552321650672078" target="_blank" rel="noopener">Dan Shipper on X</a>_

#### Guessing Locations (like in Geoguessr)

![o3 zooming into image](/static/blog/o3-and-o4-mini-for-developers/guessing_location_1.jpeg)

![o3 zooming into image](/static/blog/o3-and-o4-mini-for-developers/guessing_location_2.jpeg)
...
![o3 counting rocks](/static/blog/o3-and-o4-mini-for-developers/o3-rocks-counting.webp)
...
Read <a href="https://www.helicone.ai/blog/prompt-thinking-models" target="_blank" rel="noopener">this post</a> to learn how to prompt these models better.
...
![Codex demo](/static/blog/o3-and-o4-mini-for-developers/codex-demo.gif)

Alongside o3 and o4-mini, OpenAI released <a href="https://github.com/openai/codex" target="_blank" rel="noopener">Codex CLI</a>—an open-source coding agent that runs directly from your terminal. Built to leverage the reasoning capabilities of these new models, Codex allows developers to:
...
To support developers using Codex, OpenAI announced a <a href="https://openai.com/form/codex-open-source-fund/" target="_blank" rel="noopener">$1 million initiative</a> for open-source projects, offering grants of $25,000 in API credits.
...
Consider that Codex was made open source, their relentless focus on lower pricing and tool use, and their potential <a href="https://www.cnbc.com/2025/04/16/openai-in-talks-to-pay-about-3-billion-to-acquire-startup-windsurf.html" target="_blank" rel="noopener">acquisition of Windsurf</a>—it's quite clear that they're positioning themselves to tale Anthropic's seat as the AI provider for developers.
