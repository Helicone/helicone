...
export const metadata: Metadata = {
    title: "Helicone Projects | Community AI Projects",
    description:
        "Explore innovative AI projects built with Helicone. See how developers are creating amazing applications with our platform.",
    icons: "https://www.helicone.ai/static/logo.webp",
    openGraph: {
        type: "website",
        siteName: "Helicone.ai",
        url: "https://www.helicone.ai/projects",
        title: "Helicone Projects | Community AI Projects",
        description:
            "Explore innovative AI projects built with Helicone. See how developers are creating amazing applications with our platform.",
...
// Separate the projects grid from the page layout for better reusability
        ...
        <div className="w-full bg-background h-full antialiased relative text-foreground mb-6">
            <div className="relative w-full flex flex-col gap-4 mx-auto max-w-5xl h-full py-16 items-center text-center px-2 sm:px-2 lg:px-0">
                ...
                <P className="text-muted-foreground">
                    Innovative AI projects built with Helicone by our amazing community of developers.
                </P>
