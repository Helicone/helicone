...
<a
  ...
  className="mt-4 inline-block rounded border bg-white px-4 py-2 text-gray-700 no-underline shadow-md transition-colors duration-300 hover:bg-gray-100 hover:text-black hover:shadow-none"
>
