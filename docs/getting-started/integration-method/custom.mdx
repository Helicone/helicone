...
"twitter:title": "Custom Model Integration - Helicone Open Source LLM Observability"
---
...
const config: IHeliconeAsyncClientOptions = {
  heliconeMeta: {
    ...
    baseUrl: "https://api.helicone.ai/custom/v1/logs",
  },
};
...
POST https://api.helicone.ai/custom/v1/log
...
```sh
curl -X POST https://api.helicone.ai/custom/v1/log \
