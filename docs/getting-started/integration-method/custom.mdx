...
description: "Integrate any custom LLM, including open-source models like Llama and GPT-Neo, with Helicone. Step-by-step guide for NodeJS, Python, Go, and Curl implementations to connect your proprietary or open-source models."
...
<CardGroup cols={2}>
  ...
  <Card
    title="Go"
    icon="golang"
    href="/getting-started/integration-method/manual-logger-go"
  >
    Integrate using the Python SDK for Python applications.
  </Card>
  <Card
...
- [Go Manual Logger](/getting-started/integration-method/manual-logger-go)
