...
type ILogRequest = {
  ...
  // The name and structure of this field depends on the model you are using. Eg: for chat models it
  // is named "messages" and for embeddings models it is named "input".
  [key: string]: Array<{
