...
description: "[LiteLLM](https://github.com/BerriAI/litellm) is a model I/O library that lets you use various LLM providers like GPT, including Bedrock, Azure, Cohere, Anthropic, Ollama, Sagemaker, HuggingFace, and Replicate (over 100 LLMs)."
---

Check out the [LiteLLM Github repo](https://github.com/BerriAI/litellm) for more information.
