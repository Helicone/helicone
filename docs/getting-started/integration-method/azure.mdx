...
When using Azure, sometimes the model shows differently than what you expect. We have a series of logic to parse out the model, but the returned body of the model is inconsissent in most cases.
