...
<Step title="Create an account">
  ...
  <Step title="Integrate with AI Gateway (Recommended)">
    ...
    The fastest way to get started is with Helicone's AI Gateway - our unified OpenAI-compatible API that works with models from OpenAI, Anthropic, Vertex, Groq, and more.
    ...
    **Bring your own key:** Go to [Provider Keys](https://us.helicone.ai/providers) to securely store API keys for the providers you want to use.
    ...
    <Note>
      **Why AI Gateway?** Get immediate, OpenAI-compatible access to models from any major provider, alongside features like rate limiting, caching, prompt versioning, and complete observability - all with zero code changes beyond the base URL and API key.
    </Note>
  </Step>
