...
<Step title="Create an account">
  ...
  <Step title="Pick your preferred integration method">
    ...
    Follow the instructions depending on who your provider is.
...
<Step title="Send your first request">
  Once you have integrated with Helicone, send a request. Once received, you
  will see the request and its metrics in the `Requests` tab.
</Step>
