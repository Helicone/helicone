...
# THIS DOC IS A WIP THAT WILL REPLACE THE MANUAL DOC ONCE EVERYTHING IS SETUP
...
### Start Databases + Clickhouse + Minio
...
```bash
docker compose up -d mailhog -p 1025:1025 -p 8025:8025
```
