...
# Start Postgres
docker run -d --name helicone-postgres-atlas -e POSTGRES_DB=helicone_test -e POSTGRES_USER=postgres -e POSTGRES_PASSWORD=testpassword -p 54388:5432 -v postgres_data:/var/lib/postgresql/data postgres:17.4
atlas migrate apply --dir "file://postgres/migrations" --url "postgres://postgres:testpassword@localhost:54388/helicone_test?sslmode=disable"
```
