---
title: "Self Deploy"
description: "A quick start guide to get you up and running with a self-hosted instance of Helicone."
---
...
```bash
# Start API Service
wrangler dev --local --var WORKER_TYPE:API_SERVICE --port 8788
```
