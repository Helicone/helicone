...
sidebarTitle: "Self Deploy (Manual)"
...
<Warning>
  **Deploy with Docker Compose!** We recommend deploying with [Docker Compose](https://docs.helicone.ai/getting-started/self-deploy-docker), 
  as it works easily with just **one line**.
</Warning>
