...
<Frame caption="Proxy: flow of data. ">
  <img src="/images/example-proxy.png" alt="Helicone Proxy data flow illustrating simple integration by changing the base URL for instant request forwarding and response handling."/>
</Frame>
...
<Frame caption="Async: flow of data. ">
  <img src="/images/example-async.png" alt="Helicone Async workflow illustrating non-blocking event logging for improved application stability."/>
</Frame>
