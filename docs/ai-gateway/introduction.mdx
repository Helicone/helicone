...
<Warning>
  Still using our legacy cloud AI Gateway? Access the documentation
  [here](/features/advanced-usage/cloud-ai-gateway-overview). This version is
  being phased out in favor of a new cloud offering based on this improved
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="shuffle"
    href="/ai-gateway/concepts/load-balancing"
  >
  ...
  <Card
    ...
    icon="key"
    href="/ai-gateway/concepts/secret-management"
  >
