...
Configure integration with the Helicone platform for authentication and comprehensive observability. When enabled, requests must include a valid Helicone API key and all requests are automatically logged to your Helicone dashboard.

[Learn more](/ai-gateway/helicone-integration)

<ParamField path="helicone.enable-auth" type="boolean" default="false">
  Enable Helicone authentication and observability.
