...
<Warning>
  Helicone AI Gateway is currently only available as a self-hosted solution. Our
  cloud-based solution is coming soon.
</Warning>

<Accordion title="Still using our legacy cloud AI Gateway?">
  If you're using our existing cloud AI Gateway, find the legacy documentation
  [here](/features/advanced-usage/cloud-ai-gateway-overview).
</Accordion>
