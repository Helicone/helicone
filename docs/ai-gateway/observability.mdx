...
<Warning>
  **Authentication Required**: Observability requires Helicone authentication to
  be enabled. Please complete the [Authentication
  setup](/ai-gateway/authentication) first before enabling observability.
</Warning>
