...
<Card title="Secure Your Gateway" href="/ai-gateway/authentication" horizontal>
...
<CardGroup cols={2}>
  <Card title="AWS ECS" href="/ai-gateway/deployment/ecs">
  ...
  <Card title="Kubernetes" href="/ai-gateway/deployment/k8s">
