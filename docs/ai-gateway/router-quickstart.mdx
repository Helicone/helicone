...
<Steps>
  ...
  <Step title="Test your routers">
    ...
    <Note>
      Each router now has different rate limits (1000/min for production, 100/hour for development) applied per API key. If you exceed the limits, you'll get HTTP 429 responses.
    </Note>
  </Step>
</Steps>
