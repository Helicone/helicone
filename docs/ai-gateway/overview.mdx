...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="route"
    href="/ai-gateway/router-quickstart"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="chart-line"
    href="/ai-gateway/helicone-integration"
  >
  ...
  <Card
    ...
    icon="heart-pulse"
    href="/ai-gateway/debugging/telemetry"
  >
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="server"
    href="/ai-gateway/concepts/multi-router"
  >
  ...
  <Card
    ...
    href="/ai-gateway/concepts/model-mapping"
  >
  ...
  <Card
    title="Providers"
    icon="server-cog"
    href="/ai-gateway/concepts/providers"
  >
