...
<CardGroup cols={2}>
<Card title="Cloud Hosted" icon="cloud" href="/ai-gateway/cloud-quickstart">
  <strong>Recommended</strong> - Get started in 30 seconds with zero infrastructure
</Card>
<Card title="Self-Hosted" icon="server" href="/ai-gateway/self-hosted-quickstart">
...
<Card title="Application Health" icon="heart-pulse" href="/ai-gateway/self-hosted/debugging/telemetry">
...
<Card title="Deployment Guides" icon="book" href="/ai-gateway/self-hosted/deployment">
