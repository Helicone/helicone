...
<AccordionGroup>
  <Accordion title="Exact Parameter Matching - Default" icon="fingerprint">
    ...
    **Best for:** Most use cases where consistent responses are desired
    
    **How it works:**
    1. Configuration is merged from global → router → request headers
