...
<AccordionGroup>
  <Accordion title="Load-Balanced Based Routing (Recommended)">
  ...
  <Accordion title="Unified API Routing">
    ...
    **Features:**
    ...
    - No router-specific configuration, uses global
      rate limits and cache configuration.
  </Accordion>
  ...
  <Accordion title="Direct Provider Routing">
    ...
    **Features:**
    - Direct gateway to specific provider,
      with LLM observability when `helicone-observability.enabled: true`.
