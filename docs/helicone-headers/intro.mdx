---
title: "Introduction"
description: Easily attach headers to your proxy request with Helicone to unlock new features and capabilities
---
...
| Helicone-Omit-Response   | boolean       | Whether to omit the response from the request                  | true                                                  |
| Helicone-Omit-Request    | boolean       | Whether to omit the request from the response                  | true                                                  |

# Feature flags

| Header Name                  | Type    | Description                                                                                                            | Example |
| ---------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------- | ------- |
| Helicone-Stream-Force-Format | boolean | Some libraries do not support proper stream stitching like Ruby, this will enforce each chunk to be properly formatted | true    |
