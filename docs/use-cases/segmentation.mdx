...
[Custom Properties](features/advanced-usage/custom-properties) allows you to segment your data to derive meaningful insights. This feature can help you understand the costs and behavior of different user groups, and gain other insights to help inform strategic decisions and optimizations.
...
<CardGroup cols={3}>
  ...
  <Card title="Use Case 2" href="/integrations/azure/javascript">
    User Segmentation 
  </Card>
  <Card title="Use Case 3" href="/integrations/anthropic/javascript">
...
You can refine your segments further by incorporating other properties. Here are some examples: 
...
<Tip>The more detailed your segments, the more accurate insights you can derive.</Tip>
