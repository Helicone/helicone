...
<CardGroup cols={3}>
  <Card title="Use Case 1" href="/use-cases/segmentation#use-case-1-tracking-environments" icon="square-1">
    Tracking Environments
  </Card>
  <Card title="Use Case 2" href="/use-cases/segmentation#use-case-2-user-segmentation" icon="square-2">
    User Segmentation 
  </Card>
  <Card title="Use Case 3" href="/use-cases/segmentation#use-case-3-advanced-segmentation" icon="square-3">
