...
description: "Get user-specific requests using the Request API. "
---
...
<Frame>
 <img src="/images/use-cases/example-user-request.png" alt="Helicone Request API example showing how you can built a request and specify filtering criteria and other advanced capabilities."/>
</Frame>
