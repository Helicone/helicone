---
title: "How to run experiments with prompts"
description: "Easily maintain and version your prompts in Helicone. Test and compare the outputs using metrics you care about."
---
...
<Steps>
  <Step title="Click `Start Experiment`">
    ...
    <Frame>
  <img src="/images/use-cases/experiments/start-button.png" />
</Frame>
  ...
  <Step title="Select the base prompt">
    ...
    <Tip>
      ...
      tag.
       ...
       <Frame>
  <img src="/images/use-cases/experiments/select-prompt.png" />
</Frame>
  ...
  <Step title="Edit the prompt">
    ...
    one to test your experiment on.
       <Frame>
  <img src="/images/use-cases/experiments/edit-prompt.png" />
</Frame>
  </Step>
  <Step title="Configure your experiment">
    ...
    <Tip>
      ...
      requests.{" "}
       ...
       <Frame>
  <img src="/images/use-cases/experiments/config.png" />
</Frame>
  ...
  <Step title="Confirm and run">
    ...
    selected.
       <Frame>
  <img src="/images/use-cases/experiments/confirm.png" />
</Frame>
  ...
  <Step title="View outputs">
    ...
    associated outputs from the base prompt and the experiment.
       <Frame>
  <img src="/images/use-cases/experiments/view.png" />
</Frame>
