...
description: "We understand that low latency is crucial for the success of your LLM application. That's why we designed Helicone to impact latency as little as possible."
---
...
<Frame>![Comparison of latency between OpenAI and Helicone proxies for LLM requests](/images/getting-started/openai-helicone.png)</Frame>
