...
<Step title="Log high-quality outputs">
  Start logging successful requests from o1, Claude 3.5 Sonnet, Gemini 1.5 Pro, or other premium models that represent your ideal outputs
</Step>
...
<Step title="Fine-tune smaller models">
  Export JSONL and fine-tune GPT-4o-mini, Llama 3.1 8B, Gemini 1.5 Flash, or other models that are 10-50x cheaper
</Step>
