...
<Step title="Select alert type and threshold">
  ...
  **Cost Alerts:**
  ...
  - Optional filters let you scope the alert to a subset of traffic (e.g., only Anthropic requests or production environments)
</Step>
