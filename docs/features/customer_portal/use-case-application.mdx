...
Right now customer portal is starting at $799/month. If you are interested in getting access to the customer portal please reach out to us at [
The integration is extremely simple and can be done in minutes. You can follow our more detailed guide here: [Helicone Customer Portal Integration](https://docs.helicone.com/docs/customer-portal-integration).
