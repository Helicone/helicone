...
<Frame caption="Example: Experiment scores. ">
  <img src="/images/scores/example-experiment-scores.png" alt="Example of experiment scores compared to the original scores displayed in Helicone."/>
</Frame>
...
<Frame caption="Example: Adding scores on the request page. ">
  <img src="/images/scores/example-scores-request-page.png" alt="Example of adding scores post-request on the Requests page in Helicone."/>
</Frame>
