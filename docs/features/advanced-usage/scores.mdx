...
Helicone's scores API allows you to score your requests and experiments. You can use this feature to evaluate the performance of your prompts and compare the scores of different experiments and datasets.
