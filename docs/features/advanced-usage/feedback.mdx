...
```js Node.js
const { HeliconeProxyOpenAIApi, HeliconeProxyConfiguration, HeliconeFeedbackRating } = require('helicone'); // Replace with the actual package name
...
const { data: completions, response }: { data: ChatCompletion; response: Response } = 
