...
<Frame caption="See user metrics such as the number of requests, costs, and activities.">
  <img src="/images/user-metrics/example-user-metric.png" alt="User metrics overview: Requests, costs, and activities tracked in Helicone"/>
</Frame>
...
<Frame caption="See overview, usage and detailed logs for a specific user.">
  <img src="/images/user-metrics/example-user-metric-dashboard.png" alt="Detailed user dashboard in Helicone showing overview, usage, and logs under `Users` tab." />
</Frame>
