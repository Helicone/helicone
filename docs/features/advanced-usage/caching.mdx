...
<Info>
  **Who can use this feature**: Anyone on Pro or Enterprise [plan](https://www.helicone.ai/pricing). For Pro, the maximum number of caches
  you can store within a bucket is `20`. If you need to store more, upgrade to Enterprise.
</Info>
