...
The default caching limit is 7 days. To change your caching limit, add the `Cache-Control` header to your request.


**Example**: Setting the cache to **30 days**, aka `2592000 seconds`

```tsx
"Cache-Control": "max-age=2592000"`
```
<Note>The max caching limit is **365 days**, or `max-age=31536000`. </Note>
