...
<Frame>
  <video width="100%" autoPlay loop muted playsInline>
    <source
      src="https://marketing-assets-helicone.s3.us-west-2.amazonaws.com/prompts_create_placeholder.mp4"
      type="video/mp4"
    />
    <img
...
<Frame>
  <video width="100%" autoPlay loop muted playsInline>
    <source
      src="https://marketing-assets-helicone.s3.us-west-2.amazonaws.com/prompts_test_placeholder.mp4"
      type="video/mp4"
    />
    <img
...
<Warning>
Only `number` and `boolean` types are validated by the AI Gateway, which will accept strings for any input as long as they can be converted to valid values.
</Warning>
