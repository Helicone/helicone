...
![Job table showing all current job statuses on Helicone](/images/jobs/table.png)
...
![List format view of job nodes and their status on Helicone](/images/jobs/list.png)

and a graphical representation
![Graphical representation of job nodes and their status on Helicone](/images/jobs/graph.png)
