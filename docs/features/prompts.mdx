...
<Frame caption="Example: A Prompt Template designed for a rap battle between two people. ">
  <img src="/images/prompts/example-prompt-rap-battle.png" alt="Helicone example of a prompt template for monitoring and managing inputs from requests sent to your AI applications."/>
</Frame>
