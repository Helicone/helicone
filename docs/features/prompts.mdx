...
This updated version includes the new section about `hpstatic` within the "Get a deep dive of the feature" accordion, maintaining the structure of the original document while adding the new information.
