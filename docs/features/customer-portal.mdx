...
- Your customer uses your provider key (that Helicone securely encrypted) to
access your LLM application. - Helicone logs all requests and extracts the data
in order to bring customer insights to you. - Getting access to your customer's
usage allows you to set up billing accordingly.
