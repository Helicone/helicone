...
<Tabs>
  ...
  <Steps>
    ...
    Add `<helicone-prompt-input key="<INPUT_ID>" >` before your input and `</helicone-prompt-input>` after your input.

    ```tsx
    Write a story about <helicone-prompt-input key="scene" >a secret agent</helicone-prompt-input>
    ```
    ...
    <Step title="Make a request">
      ...
      Now when you make your request to your LLM, the LLM will receive the prompt with all of the `helicone-prompt-input` tags removed. However, Helicone will now keep track of all of your inputs for you.
    </Step>
