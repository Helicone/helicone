...
4. **Secure Key Encryption**: Provider keys are encrypted using industry-leading methods. Learn more about our encryption practices [here](@https://docs.helicone.ai/features/advanced-usage/vault#how-we-encrypt-your-provider-key-securely).
...
For more information or to start your journey toward true data ownership, contact us at [sales@helicone.ai](mailto:sales@helicone.ai) or [schedule a call with our team](https://calendly.com/d/4hs-9jb-b96/helicone-intro). We're here to help you maintain full control of your valuable data assets.

<Note>
  If your organization requires enhanced security, privacy, or compliance,
  consider our self-deployment option. Deploy Helicone on your own servers to
