...
<Info>
  For detailed information on how Helicone minimizes latency impact, including
  benchmarking results and performance metrics, check out our post on [Latency
  Impact](/references/latency-affect).
</Info>
