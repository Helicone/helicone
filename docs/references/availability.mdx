...
<Icon icon="check" size={32} /> **Your requests are handled efficiently and
reliably with Helicone.**
...
<Icon icon="check" size={32} /> **With asynchronous logging, Helicone stays out
