...
<Note>
  For complete configuration options and syntax, see the [Configuration Reference](/gateway/config#retries).
</Note>
...
Retries and [load balancing](/gateway/features/loadbalancing) work together to maximize reliability:
