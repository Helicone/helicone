...
<Steps>
  ...
  <Step title="Configure LangChain with Helicone AI Gateway">
    ...
    const chat = new ChatOpenAI({
        model: 'gpt-4.1-mini',  // Any model from Helicone registry
        temperature: 0.8,
        streaming: true,
  ...
  <Step title="View requests in the Helicone dashboard">
    All your LangChain requests are now visible in your [Helicone dashboard](https://us.helicone.ai/dashboard):
...
const chat = new ChatOpenAI({
    model: 'gpt-4.1-mini',                      // Use Helicone model names
