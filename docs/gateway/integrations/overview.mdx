...
Most often, integrating to Helicone is as simple as updating your `baseURL` to `
"https://ai-gateway.helicone.ai/v1"` and adding your Helicone API key as a header.
