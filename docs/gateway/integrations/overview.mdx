...
<CardGroup cols={2}>
  ...
  <Card title="Vercel AI SDK" icon="sparkles" href="/gateway/integrations/vercel-ai-sdk" horizontal>
  ...
  <Card title="Claude Agent SDK" icon="bot" href="/gateway/integrations/claude-agent-sdk" horizontal>
    Build AI agents with the Claude Agent SDK and automatic observability.
  </Card>
  <Card title="DSPy" icon="brain" href="/gateway/integrations/dpsy" horizontal>
    Access 100+ LLM providers with unified observability and optimization.
  </Card>
  <Card title="Langfuse" icon="chart-line" href="/gateway/integrations/langfuse" horizontal>
    Access 100+ LLM providers with observability and LLM tracing.
  </Card>
  <Card title="OpenAI Agents" icon="wrench" href="/gateway/integrations/openai-agents" horizontal>
    Build AI agents with tools and full observability.
  </Card>
  <Card title="n8n" icon="sparkles" href="/gateway/integrations/n8n" horizontal>
    Route LLM requests through the AI Gateway from n8n workflows.
  </Card>
  <Card title="PostHog" icon="chart-bar" href="/gateway/integrations/posthog" horizontal>
    Export LLM request events to PostHog for unified product analytics.
  </Card>
  <Card title="Semantic Kernel" icon="layers" href="/gateway/integrations/semantic-kernel" horizontal>
    Access 100+ LLM providers with unified observability.
  </Card>
</CardGroup>
