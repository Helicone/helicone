---
title: "Get Production Version"
api: "POST https://api.helicone.ai/v1/prompt-2025/query/production-version"
description: "Retrieve the production version of a specific prompt"
---
