...
npx @helicone/export --start-date 2024-01-01 --limit 10000

# With property filter
npx @helicone/export --property appname=MyApp --format csv

# With date range and full bodies
npx @helicone/export --start-date 2024-08-01 --end-date 2024-08-31 --include-body
```
