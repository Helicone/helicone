...
<CardGroup cols={2} gap="medium">
  ...
  <Card
    ...
    iconType="light"
  >
    This step-by-step tutorial covers function calling, response formatting, and
...
<Accordion title="Need help choosing a guide?" type="secondary">
  <p>
    ...
    <a href="/guides/getting-started">Getting Started</a> guide to begin your
    journey with Helicone.
  </p>
</Accordion>
