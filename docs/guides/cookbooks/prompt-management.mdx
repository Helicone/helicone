Helicone allows you to create and manage prompts in two ways: via the UI or within your codebase. This guide explains the difference between the two methods and how to use them effectively.
...
<Frame>
  ...
  page.](/images/prompt-playground.png)
</Frame>
