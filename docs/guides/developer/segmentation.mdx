...
<Note>
  {" "}
  If you have other use cases, we'd love to know! Send us an [email](help@helicone.ai)
  or [schedule a call](https://cal.com/team/helicone/helicone-discovery) with us.{" "}
</Note>{" "}
