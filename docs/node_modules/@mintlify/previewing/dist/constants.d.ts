export declare const TARGET_MINT_VERSION = "v0.0.369";
...
export declare const NEXT_SERVER_PATH: string;
export declare const NEXT_STATIC_PATH: string;
...
export declare const TAR_URL: string;
