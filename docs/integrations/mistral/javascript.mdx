# Mistral JavaScript Integration

This guide explains how to integrate Mistral AI with Helicone for logging and monitoring Mistral API usage using JavaScript.
...
First, install the Mistral JavaScript package:
