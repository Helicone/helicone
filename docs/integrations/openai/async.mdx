---
title: "OpenAI Integration with Async Logging"
sidebarTitle: "Async Logging"
description: "Integrate OpenAI with Helicone using Async Logging. Set up custom headers and logging without using the Helicone Proxy."
"twitter:title": "OpenAI Async Logging Integration - Helicone"
---
