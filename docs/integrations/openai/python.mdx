---
title: "OpenAI Integration with Python"
sidebarTitle: "Python"
description: "Learn how to integrate OpenAI with Helicone using Python."
"twitter:title": "OpenAI Python Integration - Helicone OSS LLM Observability
---
