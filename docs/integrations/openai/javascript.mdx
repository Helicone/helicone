---
title: "OpenAI Integration with JavaScript"
sidebarTitle: "JavaScript"
description: "Learn how to integrate OpenAI with Helicone using JavaScript."
"twitter:title": "OpenAI JavaScript Integration - Helicone OSS LLM Observability
---
