---
title: "Gemini Vertex AI Integration with JavaScript"
sidebarTitle: "JavaScript"
description: "Integrate Gemini Vertex AI with Helicone using JavaScript. Detailed instructions for setting up proxy integration and sending requests using fetch and the VertexAI SDK."
"twitter:title": "Gemini Vertex AI JavaScript Integration - Helicone OSS LLM Observability
---
