---
title: "Gemini AI Integration with JavaScript"
sidebarTitle: "JavaScript"
description: "Integrate Gemini AI with Helicone using JavaScript. Detailed instructions for setting up proxy integration and sending requests with fetch and the Google Generative AI SDK."
"twitter:title": "Gemini AI JavaScript Integration - Helicone OSS LLM Observability
---
