---
title: "Gemini AI Integration with cURL"
sidebarTitle: "cURL"
description: "Integrate Gemini AI with Helicone using cURL. Instructions for setting up proxy integration and sending requests to the Gemini AI API through the Helicone proxy."
"twitter:title": "Gemini AI cURL Integration - Helicone"
---
