---
title: "cURL"
description: "Integrate Google Generative AI with Helicone using cURL"
---
...
<Steps>
  ...
  <Step title="Send a request using cURL">
    ...
    ```bash
    curl --request POST \
      --url "https://gateway.hconeai.com/v1beta/models/model-name:generateContent?key=${GOOGLE_GENERATIVE_API_KEY}" \
