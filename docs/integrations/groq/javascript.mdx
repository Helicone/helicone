---
title: "Groq Integration with JavaScript"
sidebarTitle: "JavaScript"
description: "Integrate Groq with Helicone using JavaScript. Set up custom headers and send requests with the Groq SDK."
"twitter:title": "Groq JavaScript Integration - Helicone OSS LLM Observability
---
