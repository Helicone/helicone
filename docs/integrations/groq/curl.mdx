---
title: "Groq Integration with cURL"
sidebarTitle: "cURL"
description: "Learn how to integrate Groq with Helicone using cURL. Step-by-step guide to set up proxy integration and send requests."
"twitter:title": "Groq cURL Integration - Helicone"
---
