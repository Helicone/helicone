---
title: "Azure OpenAI Integration with Python"
sidebarTitle: "Python"
description: "Set up Azure OpenAI with Helicone using Python. Learn how to modify API configurations and add custom headers for seamless integration."
"twitter:title": "Azure OpenAI Python Integration - Helicone"
---
