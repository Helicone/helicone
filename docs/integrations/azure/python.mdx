...
<Steps>
  ...
  <Step title={strings.modifyBasePath}>
    To learn more about the differences between OpenAI and Azure OpenAI, review the [OpenAI vs Azure OpenAI](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/switching-endpoints) documentation.
    ...
    client = AzureOpenAI(
        ...
        azure_endpoint="https://[AZURE_DOMAIN].azure.com/",
    ...
    azure_openai = OpenAI(
      api_key=azure_openai_api_key,
      base_url="https://oai.helicone.ai/openai/deployments/[DEPLOYMENT_NAME]", # gpt-4
      default_headers={
        "Helicone-OpenAI-Api-Base": "https://[AZURE_DOMAIN].azure.com",
        "Helicone-Auth": f"Bearer {helicone_api_key}",
        "Helicone-Model-Override": "[MODEL_NAME]" # gpt-4
