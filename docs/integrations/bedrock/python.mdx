...
params['headers']['aws-secret-key'] = '<AWS SECRET KEY>' # optionally, you can pass the aws-session-token instead of access and secret key if you are using temporary credentials
