...
WHEN (request_response_rmt.model ILIKE 'qwen/qwen-2.5-7b-instruct') THEN 270 * request_response_rmt.prompt_tokens + 270 * request_response_rmt.completion_tokens
WHEN (request_response_rmt.model ILIKE 'nvidia/llama-3.1-nemotron-70b-instruct') THEN 350 * request_response_rmt.prompt_tokens + 400 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'liquid/lfm-40b:free') THEN 0 * request_response_rmt.prompt_tokens + 0 * request_response_rmt.completion_tokens
WHEN (request_response_rmt.model ILIKE 'liquid/lfm-40b') THEN 1000 * request_response_rmt.prompt_tokens + 2000 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'eva-unit-01/eva-qwen-2.5-14b') THEN 250 * request_response_rmt.prompt_tokens + 500 * request_response_rmt.completion_tokens
WHEN (request_response_rmt.model ILIKE 'anthracite-org/magnum-v2-72b') THEN 3750 * request_response_rmt.prompt_tokens + 4500 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.2-1b-instruct') THEN 10 * request_response_rmt.prompt_tokens + 20 * request_response_rmt.completion_tokens
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.2-90b-vision-instruct') THEN 350 * request_response_rmt.prompt_tokens + 400 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'qwen/qwen-2.5-72b-instruct') THEN 350 * request_response_rmt.prompt_tokens + 400 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'sao10k/l3.1-euryale-70b') THEN 350 * request_response_rmt.prompt_tokens + 400 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'nousresearch/hermes-3-llama-3.1-70b') THEN 400 * request_response_rmt.prompt_tokens + 400 * request_response_rmt.completion_tokens
WHEN (request_response_rmt.model ILIKE 'nousresearch/hermes-3-llama-3.1-405b:free') THEN 0 * request_response_rmt.prompt_tokens + 0 * request_response_rmt.completion_tokens
WHEN (request_response_rmt.model ILIKE 'nousresearch/hermes-3-llama-3.1-405b') THEN 1790 * request_response_rmt.prompt_tokens + 2490 * request_response_rmt.completion_tokens
WHEN (request_response_rmt.model ILIKE 'nousresearch/hermes-3-llama-3.1-405b:extended') THEN 1790 * request_response_rmt.prompt_tokens + 2490 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'sao10k/l3-lunaris-8b') THEN 2000 * request_response_rmt.prompt_tokens + 2000 * request_response_rmt.completion_tokens
WHEN (request_response_rmt.model ILIKE 'aetherwiing/mn-starcannon-12b') THEN 2000 * request_response_rmt.prompt_tokens + 2000 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'nothingiisreal/mn-celeste-12b') THEN 1500 * request_response_rmt.prompt_tokens + 1500 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.1-70b-instruct') THEN 350 * request_response_rmt.prompt_tokens + 400 * request_response_rmt.completion_tokens
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.1-70b-instruct:nitro') THEN 3900 * request_response_rmt.prompt_tokens + 3900 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.1-405b-instruct') THEN 1790 * request_response_rmt.prompt_tokens + 1790 * request_response_rmt.completion_tokens
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.1-405b-instruct:nitro') THEN 17900 * request_response_rmt.prompt_tokens + 17900 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'mistralai/mistral-nemo') THEN 130 * request_response_rmt.prompt_tokens + 130 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'google/gemma-2-9b-it') THEN 60 * request_response_rmt.prompt_tokens + 60 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'sao10k/l3-euryale-70b') THEN 350 * request_response_rmt.prompt_tokens + 400 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'mistralai/mistral-7b-instruct-v0.3') THEN 55 * request_response_rmt.prompt_tokens + 55 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'mistralai/mistral-7b-instruct') THEN 55 * request_response_rmt.prompt_tokens + 55 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3-70b-instruct') THEN 350 * request_response_rmt.prompt_tokens + 400 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3-8b-instruct:nitro') THEN 162 * request_response_rmt.prompt_tokens + 162 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'microsoft/wizardlm-2-7b') THEN 55 * request_response_rmt.prompt_tokens + 55 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'lizpreciatior/lzlv-70b-fp16-hf') THEN 350 * request_response_rmt.prompt_tokens + 400 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'undi95/remm-slerp-l2-13b') THEN 1125 * request_response_rmt.prompt_tokens + 1125 * request_response_rmt.completion_tokens
