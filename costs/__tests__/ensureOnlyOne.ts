...
WHEN (request_response_rmt.provider = 'OPENROUTER') THEN (
  CASE
  WHEN (request_response_rmt.model ILIKE 'sao10k/l3.3-euryale-70b') THEN 1500 * request_response_rmt.prompt_tokens + 1500 * request_response_rmt.completion_tokens
WHEN (request_response_rmt.model ILIKE 'inflatebot/mn-mag-mell-r1') THEN 900 * request_response_rmt.prompt_tokens + 900 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.3-70b-instruct') THEN 130 * request_response_rmt.prompt_tokens + 400 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'qwen/qwq-32b-preview') THEN 130 * request_response_rmt.prompt_tokens + 200 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'qwen/qwen-2.5-coder-32b-instruct') THEN 80 * request_response_rmt.prompt_tokens + 180 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'nvidia/llama-3.1-nemotron-70b-instruct') THEN 200 * request_response_rmt.prompt_tokens + 200 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.2-3b-instruct') THEN 18 * request_response_rmt.prompt_tokens + 30 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'nousresearch/hermes-3-llama-3.1-70b') THEN 200 * request_response_rmt.prompt_tokens + 200 * request_response_rmt.completion_tokens
WHEN (request_response_rmt.model ILIKE 'nousresearch/hermes-3-llama-3.1-405b') THEN 900 * request_response_rmt.prompt_tokens + 900 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.1-405b-instruct') THEN 900 * request_response_rmt.prompt_tokens + 900 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'meta-llama/llama-3.1-70b-instruct') THEN 130 * request_response_rmt.prompt_tokens + 400 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'mistralai/mistral-nemo') THEN 40 * request_response_rmt.prompt_tokens + 90 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'nousresearch/hermes-2-pro-llama-3-8b') THEN 30 * request_response_rmt.prompt_tokens + 30 * request_response_rmt.completion_tokens
...
WHEN (request_response_rmt.model ILIKE 'gryphe/mythomax-l2-13b') THEN 70 * request_response_rmt.prompt_tokens + 70 * request_response_rmt.completion_tokens
