...
WHEN (request_response_log.model = 'neversleep/llama-3-lumimaid-8b') THEN 225 * request_response_log.prompt_tokens + 2250 * request_response_log.completion_tokens
...
WHEN (request_response_log.model = 'meta-llama/llama-3-8b-instruct:extended') THEN 225 * request_response_log.prompt_tokens + 2250 * request_response_log.completion_tokens
WHEN (request_response_log.model = 'neversleep/llama-3-lumimaid-8b:extended') THEN 225 * request_response_log.prompt_tokens + 2250 * request_response_log.completion_tokens
...
WHEN (request_response_log.model = 'meta-llama/llama-guard-2-8b') THEN 180 * request_response_log.prompt_tokens + 180 * request_response_log.completion_tokens
...
WHEN (request_response_log.model = 'meta-llama/llama-2-70b-chat') THEN 640 * request_response_log.prompt_tokens + 800 * request_response_log.completion_tokens
WHEN (request_response_log.model = 'nousresearch/nous-hermes-llama2-13b') THEN 180 * request_response_log.prompt_tokens + 180 * request_response_log.completion_tokens
...
WHEN (request_response_log.model = 'mistralai/mistral-7b-instruct') THEN 70 * request_response_log.prompt_tokens + 70 * request_response_log.completion_tokens
...
WHEN (request_response_log.model = 'gryphe/mythomax-l2-13b') THEN 130 * request_response_log.prompt_tokens + 130 * request_response_log.completion_tokens
...
WHEN (request_response_log.model = 'lizpreciatior/lzlv-70b-fp16-hf') THEN 590 * request_response_log.prompt_tokens + 790 * request_response_log.completion_tokens
...
WHEN (request_response_log.model = 'meta-llama/llama-3-8b-instruct') THEN 70 * request_response_log.prompt_tokens + 70 * request_response_log.completion_tokens
WHEN (request_response_log.model = 'meta-llama/llama-3-70b-instruct') THEN 590 * request_response_log.prompt_tokens + 790 * request_response_log.completion_tokens
...
WHEN (request_response_log.model = 'neversleep/llama-3-lumimaid-70b') THEN 8000 * request_response_log.prompt_tokens + 8000 * request_response_log.completion_tokens
...
WHEN (request_response_log.model = 'qwen/qwen-72b-chat') THEN 900 * request_response_log.prompt_tokens + 900 * request_response_log.completion_tokens
...
WHEN (request_response_log.model = 'liuhaotian/llava-13b') THEN 10000 * request_response_log.prompt_tokens + 10000 * request_response_log.completion_tokens
