...
var regexIdentifierStart, regexIdentifierPart;
var init_path_to_regex_modified = __esm({
  "src/path-to-regex-modified.ts"() {
...
var DEFAULT_OPTIONS, HOSTNAME_OPTIONS, PATHNAME_OPTIONS, SPECIAL_SCHEMES;
...
var Parser;
var init_url_pattern_parser = __esm({
  "src/url-pattern-parser.ts"() {
    init_path_to_regex_modified();
    init_url_utils();
    Parser = class {
      constructor(input) {
        this.tokenList = [];
...
var COMPONENTS, DEFAULT_PATTERN, URLPattern;
var init_url_pattern = __esm({
  "src/url-pattern.ts"() {
    init_path_to_regex_modified();
    init_url_utils();
    init_url_pattern_parser();
    COMPONENTS = [
      "protocol",
      "username",
      "password",
...
// src/patch-global.cts
var patch_global_exports = {};
__export(patch_global_exports, {
  URLPattern: () => URLPattern2
});
module.exports = __toCommonJS(patch_global_exports);
var { URLPattern: URLPattern2 } = (init_url_pattern(), __toCommonJS(url_pattern_exports));
