...
const models: TsoaRoute.Models = {
  ...
  Provider: {
    ...
    type: {
      ...
      subSchemas: [
        ...
        { dataType: "enum", enums: ["TOGETHERAI"] },
    ...
    properties: {
      ...
      messages: {
        ...
        subSchemas: [
          {
            dataType: "array",
            array: { dataType: "refObject", ref: "Message" },
          },
          { dataType: "enum", enums: [null] },
        ],
      },
  ...
  Response: {
    ...
    properties: {
      completions: {
        dataType: "union",
        subSchemas: [
          { ref: "Record_number.string_" },
          { dataType: "enum", enums: [null] },
        ],
      },
      message: {
        dataType: "union",
        subSchemas: [{ ref: "Message" }, { dataType: "enum", enums: [null] }],
      },
      error: {
        dataType: "union",
        subSchemas: [{ ref: "ErrorInfo" }, { dataType: "enum", enums: [null] }],
      },
      model: {
        dataType: "union",
        subSchemas: [
  ...
  LlmSchema: {
    ...
    properties: {
      ...
      response: {
        dataType: "union",
        subSchemas: [{ ref: "Response" }, { dataType: "enum", enums: [null] }],
      },
    },
    additionalProperties: false,
  },
  ...
  Partial_RequestResponseSearchToOperators_: {
    ...
    type: {
      dataType: "nestedObjectLiteral",
      nestedProperties: {
        request_body_vector: { ref: "Partial_VectorOperators_" },
        response_body_vector: { ref: "Partial_VectorOperators_" },
      },
      validators: {},
    },
  },
      ...
      type: {
        ...
        nestedProperties: {
          ...
          request_response_search: {
            ref: "Partial_RequestResponseSearchToOperators_",
          },
        },
        validators: {},
      },
  ...
  "FilterLeafSubset_feedback-or-request-or-response-or-properties-or-values-or-request_response_search_":
    {
      dataType: "refAlias",
      type: {
        ref: "Pick_FilterLeaf.feedback-or-request-or-response-or-properties-or-values-or-request_response_search_",
        validators: {},
      },
    },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  RequestFilterNode: {
    ...
    type: {
      ...
      subSchemas: [
        {
          ref: "FilterLeafSubset_feedback-or-request-or-response-or-properties-or-values-or-request_response_search_",
        },
  ...
  "Record_string.ScoreValue_": {
    ...
    type: {
      dataType: "nestedObjectLiteral",
      nestedProperties: {},
      additionalProperties: { ref: "ScoreValue" },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  ExperimentScores: {
    ...
    properties: {
      dataset: {
        dataType: "nestedObjectLiteral",
        nestedProperties: {
          scores: { ref: "Record_string.ScoreValue_", required: true },
        },
        required: true,
      },
      hypothesis: {
...
export function RegisterRoutes(app: Router) {
    ...
    async function ExperimentDatasetController_getDatasets(
      ...
      const args: Record<string, TsoaRoute.ParameterSchema> = {
        requestBody: {
          ...
          required: true,
          dataType: "nestedObjectLiteral",
          nestedProperties: { promptId: { dataType: "string" } },
        },
        request: {
          in: "request",
          name: "request",
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      ExperimentController.prototype.createNewExperiment
    ),

    async function ExperimentController_createNewExperiment(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(ExperimentController),
    ...fetchMiddlewares<RequestHandler>(
      ExperimentController.prototype.getExperiments
    ),

    async function ExperimentController_getExperiments(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.post(
    ...
    async function DataIsBeautifulRouter_createNewExperiment(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
